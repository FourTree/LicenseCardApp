...
public class PBOC extends Applet implements AppletEvent {
	 ...
	 * app name CFCPBOC
	 */
	private static final byte[] app_name = new byte[] { 0x43, 0x46, 0x43, 0x50,
			0x42, 0x4F, 0x43 };

	private byte[] backRecord;

	private static final boolean FUNCTION_FOR_TIANYU = true;
	...
	/**
	 * pre-auth trade context array, item(1 byte sfi + 2 byte ID + 6 byte
	 * pre-authorization money = 9 byte) * item number
	 */
	...
	// qPBOC & comprehensive application GPO Response offline template (need
	// feed ATC\AC,optional FDDA\\9F5D)
	...
	private static final byte CMD_INS_GET_SIGN_DATA = (byte) 0xB8;
	private static final byte CMD_INS_VERIFY_SIGN = (byte) 0xB9;
	/**
	...
	/**
	 * 0xDF78, 6 byte, 第二币种电子现金单笔交易限额(EC Secondary Application Single
	 * Transaction Limit)
	 */
	...
	private static final byte[] LOG_INCREASE_VAR = new byte[] { 0x00, 0x00,
			0x00, 0x01 };

	/**
	 * CDOL1 Value/CDOL2 Value offset
	 */
	private static final short terminalDataCDOLTable[] = { TAG_TRADE_COIN_CODE,
			CDOLV_OFF_CDOL1_TRADE_COIN_CODE, CDOLV_OFF_CDOL2_TRADE_COIN_CODE,
			TAG_TRADE_AUTH_MONEY, CDOLV_OFF_CDOL1_TRADE_AUTH_MONEY,
			CDOLV_OFF_CDOL2_TRADE_AUTH_MONEY, TAG_TERMINAL_TRADE_RANDOM,
			CDOLV_OFF_CDOL1_TERMINAL_TRADE_RANDOM,
			CDOLV_OFF_CDOL2_TERMINAL_TRADE_RANDOM, TAG_TRADE_OTHER_MONEY,
			CDOLV_OFF_CDOL1_TRADE_OTHER_MONEY,
			CDOLV_OFF_CDOL2_TRADE_OTHER_MONEY, TAG_STATE_CODE,
			CDOLV_OFF_CDOL1_TERMINAL_STATE_CODE,
			CDOLV_OFF_CDOL2_TERMINAL_STATE_CODE,

			TAG_TVR, CDOLV_OFF_CDOL1_TVR, CDOLV_OFF_CDOL2_TVR, TAG_TRADE_DATE,
			CDOLV_OFF_CDOL1_TRADE_DATE, CDOLV_OFF_CDOL2_TRADE_DATE,
			TAG_TRADE_TYPE, CDOLV_OFF_CDOL1_TRADE_TYPE,
			CDOLV_OFF_CDOL2_TRADE_TYPE, TAG_AUTH_CODE, INVALID_VALUE,
			CDOLV_OFF_CDOL2_AUTH_CODE,
	...
	private static final short analyseTable[] = {
			TAG_2ND_TRACK_DATA,
			CARD_DATA_OFF_2ND_TRACK_DATA,
			20, // 二磁道等价数据(20 byte),LV struct,tag 57
			TAG_CARD_HOLDER_NAME,
			CARD_DATA_OFF_CARD_HOLDER_NAME,
			27, // 持卡人姓名(27 byte)，tag 5F20
			TAG_APP_PAN_SEQUENCE_NO,
			CARD_DATA_OFF_PAN,
			0x01, // 应用PAN序列号(1 byte)，tag 5F34
			TAG_PREVIOUS_ATC,
			CARD_DATA_OFF_PREONLINE_ATC,
			0x02, // PreOnlineATC上次联机交易计数器(2 byte),tag 9F13
			TAG_ATC,
			CARD_DATA_OFF_ATC,
			0x02, // ATC交易计数器(2 byte),tag 9F36

			TAG_APP_COIN_CODE,
			CARD_DATA_OFF_APPCOINCODE,
			0x02, // 应用货币代码(2 byte)，tag 9F51
			TAG_APP_DEFAULT_ACTION,
			CARD_DATA_OFF_ADA,
			0x02, // ADA 应用缺省行为(2 byte)，tag 9F52
			TAG_COIN_SEQ_OFFLINE_TRADE_MAX_CNTR,
			CARD_DATA_OFF_COIN_OFFLINE_CARD_LIMIT,
			0x01, // 连续脱机交易限制数(国际-货币)(1 byte)，tag 9F53
			TAG_TOTAL_OFFLINE_TRADE_MAX_MONEY,
			CARD_DATA_OFF_TOTAL_CARD_MONEY_LIMIT,
			0x06, // 累计脱机交易金额限制(6 byte)，tag 9F54
			TAG_ISSUE_AUTH_INDICATE,
			CARD_DATA_OFF_ISSUE_AUTH_INDICATE,
			0x01, // 发卡行认证指示位(1 byte)，tag 9F56

			TAG_ISSUE_STATE_CODE,
			CARD_DATA_OFF_ISSUE_STATE_CODE,
			0x02, // 发卡行国家代码(2 byte)，tag 9F57
			TAG_SEQ_OFFLINE_TRADE_LOWER_LIMIT,
			CARD_DATA_OFF_OFFLINE_CARD_LOWLIMIT,
			0x01, // 连续脱机交易下限(1 byte)，tag 9F58
			TAG_SEQ_OFFLINE_TRADE_UPPER_LIMIT,
			CARD_DATA_OFF_OFFLINE_CARD_UPLIMIT,
			0x01, // 连续脱机交易上限(1 byte)，tag 9F59
			TAG_TOTAL_OFFLINE_TRADE_UPPER_LIMIT,
			CARD_DATA_OFF_TOTAL_CARD_MONEY_UPLIMIT,
			0x06, // 累计脱机交易金额上限(6 byte)，tag 9F5C
			TAG_AVAILABLE_OFFLINE_MONEY,
			CARD_DATA_OFF_AVAILABLE_OFFLINE_MONEY,
			0x06, // 可用脱机消费金额(6 byte), tag 9F5D

			TAG_PRODUCET_ID_INFO,
			CARD_DATA_OFF_PRODUCET_ID_INFO,
			0x10, // 产品标识信息(16 byte), tag 9F63
			TAG_CARD_PLUS_PROCESS,
			CARD_DATA_OFF_CARD_PLUS_PROCESS,
			0x04, // 卡片附加处理(4 byte)，tag 9F68
			TAG_CARD_CVM_LIMIT,
			CARD_DATA_OFF_CARD_CVM_LIMIT,
			0x06, // 卡片CVM限额(6 byte)，tag 9F6B
			TAG_CARD_TRADE_ATTRIBUTE,
			CARD_DATA_OFF_CARD_TRADE_ATTRIBUTE,
			0x02, // 卡片交易属性(2 byte)，tag 9F6C
			TAG_EC_RESET_THRESHOLD,
			CARD_DATA_OFF_EC_RESET_THRESHOLD,
			0x06, // 电子现金重置阈值(6 byte)，tag 9F6D

			TAG_STATE_SEQ_OFFLINE_TRADE_MAX_CNTR,
			CARD_DATA_OFF_STATE_OFFLINE_CARD_LIMIT,
			0x01, // 连续脱机交易限制数(国际-国家)(1 byte),tag 9F72
			TAG_COIN_CONVERT_GENE,
			CARD_DATA_OFF_COIN_CONVERT_GENE,
			0x04, // 货币转换因子(4 byte),tag 9F73
			TAG_TOTAL_OFFLINE_TRADE_MAX_MONEY_DCOIN,
			CARD_DATA_OFF_DCOIN_TOTAL_CARD_MONEY_LIMIT,
			0x06, // 累计脱机交易金额限制双货币(6 byte),tag 9F75
			TAG_SECOND_APP_COIN_CODE,
			CARD_DATA_OFF_SECOND_APP_COIN_CODE,
			0x02, // 第二应用货币代码(2 byte),tag 9F76
			TAG_EC_BALANCE_LIMIT,
			CARD_DATA_OFF_EC_BALANCE_UPLIMIT,
			0x06, // 电子现金余额上限(6 byte),tag 9F77

			TAG_SINGLE_TRADE_LIMIT,
			CARD_DATA_OFF_SINGLE_CARD_LIMIT,
			0x06, // 电子现金单笔交易限额(6 byte),tag 9F78
			TAG_EC_BALANCE,
			CARD_DATA_OFF_EC_BALANCE,
			0x06, // 电子现金余额(6 byte), tag 9F79
			TAG_CAPP_SP_DEDUCTION_LIMIT,
			CARD_DATA_OFF_SP_DEDUCTION_LIMIT,
			0x06, // 电子现金分段扣费抵扣限额(6 byte), tag 0xDF62
			TAG_CAPP_SP_DEDUCTION_MONEY,
			CARD_DATA_OFF_SP_DEDUCTION_MONEY,
			0x06, // 电子现金分段扣费已抵扣额(6 byte), tag 0xDF63
			TAG_EC_SECOND_APP_COIN_CODE,
			CARD_DATA_OFF_EC_SECOND_APP_COIN_CODE,
			0x02, // 0xDF71, 2 byte, 第二币种电子现金应用货币代码

			TAG_EC_SECOND_CVM_LIMIT,
			CARD_DATA_OFF_EC_SECOND_CVM_LIMIT,
			0x06, // 0xDF72, 6 byte, 第二币种卡片 CVM 限额
			TAG_EC_SECOND_RESET_THRESHOLD,
			CARD_DATA_OFF_EC_SECOND_RESET_THRESHOLD,
			0x06, // 0xDF76, 6 byte, 第二币种电子现金重置阈值
			TAG_EC_SECOND_BALANCE_LIMIE,
			CARD_DATA_OFF_EC_SECOND_BALANCE_LIMIE,
			0x06, // 0xDF77, 6 byte, 第二币种电子现金余额上限
			TAG_EC_SECOND_SINGLE_TRADE_LIMIT,
			CARD_DATA_OFF_EC_SECOND_SINGLE_TRADE_LIMIT, 0x06, // 0xDF78, 6 byte,
																// 第二币种电子现金单笔交易限额
			TAG_EC_SECOND_BALANCE, CARD_DATA_OFF_EC_SECOND_BALANCE, 0x06, // 0xDF79,
																			// 6
																			// byte,
																			// 第二币种电子现金余额
	 ...
	 */
	private static short getDataTags[] = { TAG_PREVIOUS_ATC,
			CARD_DATA_OFF_PREONLINE_ATC, (short) 0x02, TAG_PIN_RETRY_CNTR,
			INVALID_VALUE, INVALID_VALUE, TAG_ATC, CARD_DATA_OFF_ATC,
			(short) 0x02, TAG_LOG_FORMAT, INVALID_VALUE, INVALID_VALUE,
			TAG_APP_COIN_CODE, CARD_DATA_OFF_APPCOINCODE, (short) 0x02,

			TAG_APP_DEFAULT_ACTION, CARD_DATA_OFF_ADA, (short) 0x02,
			TAG_COIN_SEQ_OFFLINE_TRADE_MAX_CNTR,
			CARD_DATA_OFF_COIN_OFFLINE_CARD_LIMIT, (short) 0x01,
			TAG_TOTAL_OFFLINE_TRADE_MAX_MONEY,
			CARD_DATA_OFF_TOTAL_CARD_MONEY_LIMIT, (short) 0x06,
			TAG_ISSUE_AUTH_INDICATE, CARD_DATA_OFF_ISSUE_AUTH_INDICATE,
			(short) 0x01, TAG_ISSUE_STATE_CODE, CARD_DATA_OFF_ISSUE_STATE_CODE,
			(short) 0x02,

			TAG_SEQ_OFFLINE_TRADE_LOWER_LIMIT,
			CARD_DATA_OFF_OFFLINE_CARD_LOWLIMIT, (short) 0x01,
			TAG_SEQ_OFFLINE_TRADE_UPPER_LIMIT,
			CARD_DATA_OFF_OFFLINE_CARD_UPLIMIT, (short) 0x01,
			TAG_TOTAL_OFFLINE_TRADE_UPPER_LIMIT,
			CARD_DATA_OFF_TOTAL_CARD_MONEY_UPLIMIT, (short) 0x06,
			TAG_AVAILABLE_OFFLINE_MONEY, CARD_DATA_OFF_AVAILABLE_OFFLINE_MONEY,
			(short) 0x06, TAG_CARD_PLUS_PROCESS,
			CARD_DATA_OFF_CARD_PLUS_PROCESS, (short) 0x04,

			TAG_CARD_CVM_LIMIT, CARD_DATA_OFF_CARD_CVM_LIMIT, (short) 0x06,
			TAG_EC_RESET_THRESHOLD, CARD_DATA_OFF_EC_RESET_THRESHOLD,
			(short) 0x06, TAG_STATE_SEQ_OFFLINE_TRADE_MAX_CNTR,
			CARD_DATA_OFF_STATE_OFFLINE_CARD_LIMIT, (short) 0x01,
			TAG_COIN_CONVERT_GENE, CARD_DATA_OFF_COIN_CONVERT_GENE,
			(short) 0x04, TAG_TOTAL_OFFLINE_TRADE_MAX_MONEY_DCOIN,
			CARD_DATA_OFF_DCOIN_TOTAL_CARD_MONEY_LIMIT, (short) 0x06,

			TAG_SECOND_APP_COIN_CODE, CARD_DATA_OFF_SECOND_APP_COIN_CODE,
			(short) 0x02, TAG_EC_BALANCE_LIMIT,
			CARD_DATA_OFF_EC_BALANCE_UPLIMIT, (short) 0x06,
			TAG_SINGLE_TRADE_LIMIT, CARD_DATA_OFF_SINGLE_CARD_LIMIT,
			(short) 0x06, TAG_EC_BALANCE, CARD_DATA_OFF_EC_BALANCE,
			(short) 0x06, TAG_CHARGE_LOG_FORMAT, INVALID_VALUE, INVALID_VALUE,

			TAG_CAPP_SECTION_PURCHASE_APP_ID, INVALID_VALUE, (short) 0x01,
			TAG_CAPP_SP_DEDUCTION_LIMIT, CARD_DATA_OFF_SP_DEDUCTION_LIMIT,
			(short) 0x06, TAG_CAPP_SP_DEDUCTION_MONEY,
			CARD_DATA_OFF_SP_DEDUCTION_MONEY, (short) 0x06,

			TAG_EC_SECOND_APP_COIN_CODE, CARD_DATA_OFF_EC_SECOND_APP_COIN_CODE,
			(short) 0x02, TAG_EC_SECOND_CVM_LIMIT,
			CARD_DATA_OFF_EC_SECOND_CVM_LIMIT, (short) 0x06,
			TAG_EC_SECOND_RESET_THRESHOLD,
			CARD_DATA_OFF_EC_SECOND_RESET_THRESHOLD, (short) 0x06,
			TAG_EC_SECOND_BALANCE_LIMIE, CARD_DATA_OFF_EC_SECOND_BALANCE_LIMIE,
			(short) 0x06, TAG_EC_SECOND_SINGLE_TRADE_LIMIT,
			CARD_DATA_OFF_EC_SECOND_SINGLE_TRADE_LIMIT, (short) 0x06,
			TAG_EC_SECOND_BALANCE, CARD_DATA_OFF_EC_SECOND_BALANCE,
			(short) 0x06,
	 ...
	 */
	private static short putDataTags[] = { TAG_COIN_SEQ_OFFLINE_TRADE_MAX_CNTR,
			CARD_DATA_OFF_COIN_OFFLINE_CARD_LIMIT, (short) 0x01,
			TAG_TOTAL_OFFLINE_TRADE_MAX_MONEY,
			CARD_DATA_OFF_TOTAL_CARD_MONEY_LIMIT, (short) 0x06,
			TAG_SEQ_OFFLINE_TRADE_LOWER_LIMIT,
			...
			TAG_EC_BALANCE_LIMIT, CARD_DATA_OFF_EC_BALANCE_UPLIMIT,
			(short) 0x06, TAG_SINGLE_TRADE_LIMIT,
			CARD_DATA_OFF_SINGLE_CARD_LIMIT, (short) 0x06, TAG_EC_BALANCE,
			CARD_DATA_OFF_EC_BALANCE, (short) 0x06,
			TAG_CAPP_SECTION_PURCHASE_APP_ID, INVALID_VALUE, (short) 0x01,
			TAG_CAPP_SP_DEDUCTION_LIMIT, CARD_DATA_OFF_SP_DEDUCTION_LIMIT,
			(short) 0x06,

			TAG_EC_SECOND_CVM_LIMIT, CARD_DATA_OFF_EC_SECOND_CVM_LIMIT,
			(short) 0x06, TAG_EC_SECOND_RESET_THRESHOLD,
			CARD_DATA_OFF_EC_SECOND_RESET_THRESHOLD, (short) 0x06,
			TAG_EC_SECOND_BALANCE_LIMIE, CARD_DATA_OFF_EC_SECOND_BALANCE_LIMIE,
			(short) 0x06, TAG_EC_SECOND_SINGLE_TRADE_LIMIT,
			CARD_DATA_OFF_EC_SECOND_SINGLE_TRADE_LIMIT, (short) 0x06,
	...
	/**
	 * Temp variable for STORE-DATA P2. It's not use RAM because Perso is a
	 * small quantity of operation.
	 */
	private byte blockNum;
	/**
	 * RAM Cache flag, true means use RAM cache buf, false means use flash cache
	 * buf
	 */
	...
	static private short vkeyLength = (short) 0x0400;// 1024

	private Cipher vcipherDecPkcs;
	private static final byte[] vrsaExponent = new byte[] { (byte) 0x01,
			(byte) 0x00, (byte) 0x01 };
	private static final byte[] vrsaModulus = new byte[] { (byte) 0x84,
			(byte) 0x3E, (byte) 0x49, (byte) 0x30, (byte) 0x87, (byte) 0x54,
			(byte) 0xD4, (byte) 0x8E, (byte) 0x9E, (byte) 0x4E, (byte) 0x5F,
			(byte) 0x1C, (byte) 0xB7, (byte) 0x43, (byte) 0x13, (byte) 0x15,
			(byte) 0x81, (byte) 0x49, (byte) 0xE3, (byte) 0x0F, (byte) 0x25,
			(byte) 0x38, (byte) 0x63, (byte) 0xCE, (byte) 0xA1, (byte) 0xF9,
			(byte) 0x1D, (byte) 0xF7, (byte) 0xAB, (byte) 0xFF, (byte) 0xDD,
			(byte) 0x5B, (byte) 0x56, (byte) 0x40, (byte) 0xE7, (byte) 0x6D,
			(byte) 0xFD, (byte) 0x22, (byte) 0x4E, (byte) 0x85, (byte) 0xC5,
			(byte) 0x82, (byte) 0x8B, (byte) 0x80, (byte) 0xCD, (byte) 0x12,
			(byte) 0x15, (byte) 0xBF, (byte) 0x79, (byte) 0x2F, (byte) 0x5D,
			(byte) 0xB8, (byte) 0x24, (byte) 0x3E, (byte) 0x1F, (byte) 0xA4,
			(byte) 0x28, (byte) 0x6A, (byte) 0x27, (byte) 0x3B, (byte) 0x38,
			(byte) 0xEB, (byte) 0x1B, (byte) 0x4F, (byte) 0xFD, (byte) 0x3E,
			(byte) 0x51, (byte) 0x3A, (byte) 0x1E, (byte) 0x2F, (byte) 0x64,
			(byte) 0x8C, (byte) 0xAF, (byte) 0xE7, (byte) 0xCB, (byte) 0x91,
			(byte) 0x32, (byte) 0x31, (byte) 0x6E, (byte) 0xF3, (byte) 0x18,
			(byte) 0x2E, (byte) 0x8A, (byte) 0x32, (byte) 0x16, (byte) 0x6F,
			(byte) 0x12, (byte) 0x43, (byte) 0xFF, (byte) 0xA5, (byte) 0x1E,
			(byte) 0x29, (byte) 0xF1, (byte) 0x29, (byte) 0x9E, (byte) 0x08,
			(byte) 0x1F, (byte) 0xE7, (byte) 0xA8, (byte) 0xB1, (byte) 0x89,
			(byte) 0x8D, (byte) 0xA5, (byte) 0x3E, (byte) 0xE0, (byte) 0xD9,
			(byte) 0x11, (byte) 0xBD, (byte) 0x9B, (byte) 0xEC, (byte) 0xC3,
			(byte) 0x7C, (byte) 0x98, (byte) 0x7B, (byte) 0xB7, (byte) 0x4B,
			(byte) 0x85, (byte) 0x7A, (byte) 0x32, (byte) 0x13, (byte) 0xFC,
	...
	private void initVariables() {
		...
		Util.arrayFillNonAtomic(paramBuf, (short) 0x00, PBOC_PARAM_BUF_SIZE,
				(byte) 0x00);
		Util.arrayFillNonAtomic(cardDataBuf, (short) 0x00, CARD_DATA_BUF_SIZE,
				(byte) 0x00);
		// if value equal 0xFF means tag not perso
		Util.arrayFillNonAtomic(cardDataBuf,
				CARD_DATA_OFF_COIN_OFFLINE_CARD_LIMIT, (short) 0x04,
				(byte) 0xFF);
	...
	private PBOC() {
		...
		abyPBOCTradeSession = JCSystem.makeTransientByteArray(
				TRADE_SESSION_DATA_BUF_SIZE, JCSystem.CLEAR_ON_DESELECT);
		if (FUNCTION_FOR_TIANYU) {
			abyCurTradeCardData = JCSystem.makeTransientByteArray(
					CURRENT_TRADE_CARD_DATA_BUF_SIZE, JCSystem.CLEAR_ON_RESET);
			sessionKey = JCSystem.makeTransientByteArray((short) 0x10,
					JCSystem.CLEAR_ON_RESET);
			tripleDesKey = (DESKey) KeyBuilder.buildKey(
					KeyBuilder.TYPE_DES_TRANSIENT_RESET,
					KeyBuilder.LENGTH_DES3_2KEY, false);
			curTradeConditions = JCSystem.makeTransientBooleanArray(
					CURRENT_TRADE_CONDITION_SIZE, JCSystem.CLEAR_ON_RESET);
		} else {
			abyCurTradeCardData = JCSystem.makeTransientByteArray(
					CURRENT_TRADE_CARD_DATA_BUF_SIZE,
			...
			tripleDesKey = (DESKey) KeyBuilder.buildKey(
					...
					KeyBuilder.LENGTH_DES3_2KEY, false);
			curTradeConditions = JCSystem.makeTransientBooleanArray(
					CURRENT_TRADE_CONDITION_SIZE, JCSystem.CLEAR_ON_DESELECT);
		}

		tripleDesKey.setKey(sessionKey, (short) 0x00);
		signMac = Signature.getInstance(
		...
		vkeypair = new KeyPair(KeyPair.ALG_RSA_CRT, vkeyLength);// 创建公私钥对对象
		vkeypair.genKeyPair();
...
//		signaturedata = new byte[SIGNATURE_DATA_LEN];// 测试用
	 ...
	 *            perso data lenth.
	 */
	private void analyseRecordData(short dgi, byte[] cmdbuf, short sOff,
			short sLen) {
		...
		while (sOff < sLen) {
			...
			if (sIndex == INVALID_VALUE) {
				...
				if (sTag == TAG_SIGN_DYNAMIC_APP_DATA) {
					...
					short sCDOLValueLen = PBOCUtil.getValueLenByTLList(cmdbuf,
							sOff, sValueLen);
					cdol1 = new byte[sValueLen];
					Util.arrayCopy(cmdbuf, sOff, cdol1, (short) 0x00, sValueLen);
					if (FUNCTION_FOR_TIANYU) {
						cdol1Value = JCSystem.makeTransientByteArray(
								sCDOLValueLen, JCSystem.CLEAR_ON_RESET);
					} else {
						cdol1Value = JCSystem.makeTransientByteArray(
								sCDOLValueLen, JCSystem.CLEAR_ON_DESELECT);
					}
					...
					if (FUNCTION_FOR_TIANYU) {
						cdol2Value = JCSystem.makeTransientByteArray(
								sCDOLValueLen, JCSystem.CLEAR_ON_RESET);
					} else {
						cdol2Value = JCSystem.makeTransientByteArray(
								sCDOLValueLen, JCSystem.CLEAR_ON_DESELECT);
					...
					paramBuf[PBOC_PARAM_OFF_DDOLVALUE_LEN] = (byte) PBOCUtil
							.getValueLenByTLList(cmdbuf, sOff, sValueLen);
				} else if (sTag == TAG_LOG_FORMAT) {
					logFormat = new byte[sValueLen];
					Util.arrayCopy(cmdbuf, sOff, logFormat, (short) 0x00,
							sValueLen);
				} else if (sTag == TAG_CHARGE_LOG_FORMAT) {
					chargelogFormat = new byte[sValueLen];
					Util.arrayCopy(cmdbuf, sOff, chargelogFormat, (short) 0x00,
							sValueLen);
			...
			if ((sTag == TAG_2ND_TRACK_DATA) || (sTag == TAG_CARD_HOLDER_NAME)) {
				...
				Util.arrayCopy(
						...
						sOff,
						cardDataBuf,
						(short) (analyseTable[(short) (sIndex + ANALYSE_TABLE_OFF_VALUE_OFF)] + 1),
						sValueLen);
			} else {
				...
				Util.arrayCopy(
						...
						sOff,
						cardDataBuf,
						(short) (analyseTable[(short) (sIndex + ANALYSE_TABLE_OFF_VALUE_OFF)] & 0x00FF),
						sValueLen);
			}
	 ...
	 * 
	 * @param dgi
	 *            DGI of perso data, should be sfi+num.
	 * @param cmdbuf
	 *            perso data buffer.
	 * @param sOff
	 *            perso data offset.
	 ...
	 *            perso data lenth.
	 */
	private void persoRecContent(short dgi, byte[] cmdbuf, short sOff,
			short sLen) {
		byte index;
		byte[] record;
		short recordLen;
	...
	private void persoRSACRTKey(short dgi, byte[] cmdbuf, short sOff, short sLen) {
		if (priCRTKey == null) {
			priCRTKey = (RSAPrivateCrtKey) KeyBuilder
					.buildKey(KeyBuilder.TYPE_RSA_CRT_PRIVATE,
							(short) (sLen * 16), false);
		}
		...
		if (priCRTKey.isInitialized()) {
			try {
				...
				case CryptoException.ILLEGAL_VALUE:
					ISOException
							.throwIt((short) (0x9E00 | CryptoException.ILLEGAL_VALUE));
				case CryptoException.UNINITIALIZED_KEY:
					ISOException
							.throwIt((short) (0x9E00 | CryptoException.UNINITIALIZED_KEY));
				case CryptoException.NO_SUCH_ALGORITHM:
					ISOException
							.throwIt((short) (0x9E00 | CryptoException.NO_SUCH_ALGORITHM));
				case CryptoException.INVALID_INIT:
					ISOException
							.throwIt((short) (0x9E00 | CryptoException.INVALID_INIT));
				case CryptoException.ILLEGAL_USE:
					ISOException
							.throwIt((short) (0x9E00 | CryptoException.ILLEGAL_USE));
				default:
	...
	private void getTerminalDataOffInPODLValue() {
		if (qpbocpdol != null) {
			...
			sQPDOLECTerSupportIndicateOff = PBOCUtil.findValuePosInTLList(
					TAG_EC_TERMINAL_SUPPORT_INDICATE, qpbocpdol, (short) 0x00,
					qpbocpdolLen);
			sQPDOLVTerminalTradeAttrOff = PBOCUtil.findValuePosInTLList(
					TAG_TERMINAL_TRADE_ATTRIBUTE, qpbocpdol, (short) 0x00,
					qpbocpdolLen);
			sQPDOLTradeCoinCodeOff = PBOCUtil.findValuePosInTLList(
					TAG_TRADE_COIN_CODE, qpbocpdol, (short) 0x00, qpbocpdolLen);
			sQPDOLTradeAuthMoneyOff = PBOCUtil
					.findValuePosInTLList(TAG_TRADE_AUTH_MONEY, qpbocpdol,
							(short) 0x00, qpbocpdolLen);
			sQPDOLTerminalTradeRandomOff = PBOCUtil
					.findValuePosInTLList(TAG_UNFORESEE_NUMBER, qpbocpdol,
							(short) 0x00, qpbocpdolLen);
			sQPDOLTradeOtherMoneyOff = PBOCUtil.findValuePosInTLList(
					TAG_TRADE_OTHER_MONEY, qpbocpdol, (short) 0x00,
					qpbocpdolLen);
			sQPDOLTerminalStateCodeOff = PBOCUtil.findValuePosInTLList(
					TAG_STATE_CODE, qpbocpdol, (short) 0x00, qpbocpdolLen);
			sQPDOLTerminalResultOff = PBOCUtil.findValuePosInTLList(TAG_TVR,
					qpbocpdol, (short) 0x00, qpbocpdolLen);
			sQPDOLTradeDateOff = PBOCUtil.findValuePosInTLList(TAG_TRADE_DATE,
					qpbocpdol, (short) 0x00, qpbocpdolLen);
			sQPDOLTradeTypeOff = PBOCUtil.findValuePosInTLList(TAG_TRADE_TYPE,
					qpbocpdol, (short) 0x00, qpbocpdolLen);
			sQPDOLCAPPIndicateOff = PBOCUtil.findValuePosInTLList(
					TAG_CAPP_INDICATE, qpbocpdol, (short) 0x00, qpbocpdolLen);
		} else {
		...
		if (pbocpdol != null) {
			...
			sPPDOLECTerSupportIndicateOff = PBOCUtil.findValuePosInTLList(
					TAG_EC_TERMINAL_SUPPORT_INDICATE, pbocpdol, (short) 0x00,
					pbocpdolLen);
			sPPDOLTradeCoinCodeOff = PBOCUtil.findValuePosInTLList(
					TAG_TRADE_COIN_CODE, pbocpdol, (short) 0x00, pbocpdolLen);
			sPPDOLTradeAuthMoneyOff = PBOCUtil.findValuePosInTLList(
					TAG_TRADE_AUTH_MONEY, pbocpdol, (short) 0x00, pbocpdolLen);
		} else {
	...
	private void getTerminalDataOffInCDOLValue() {
		...
		for (short i = 0x00; terminalDataCDOLTable[i] != INVALID_VALUE; i += 0x03) {
			if (terminalDataCDOLTable[(short) (i + 0x01)] != INVALID_VALUE) {
				terDataInCDOLVOff[terminalDataCDOLTable[(short) (i + 0x01)]] = (byte) PBOCUtil
						.findValuePosInTLList(terminalDataCDOLTable[i], cdol1,
								(short) 0x00, cdol1Len);
			}

			if (terminalDataCDOLTable[(short) (i + 0x02)] != INVALID_VALUE) {
				terDataInCDOLVOff[terminalDataCDOLTable[(short) (i + 0x02)]] = (byte) PBOCUtil
						.findValuePosInTLList(terminalDataCDOLTable[i], cdol2,
								(short) 0x00, cdol2Len);
			}
		}
	}
	...
	private void persoFCI(short dgi, byte[] cmdbuf, short sOff, short sLen) {
		...
		// append AID 84 TLV
		sfciOff = PBOCUtil.appendTLV((short) 0x84, cmdbuf,
				(short) (sOff + sLen), sTmp, fci, sfciOff);
		// append A5 TLV
		...
		short sPDOLValueLen;
		sPDOLValueLen = PBOCUtil.getValueLenByTLList(cmdbuf, sTmp,
				cmdbuf[(short) (sTmp - 1)]);
		...
		if (dgi == DGI_PERSO_9102) {
			...
			Util.arrayCopy(cmdbuf, sTmp, pbocpdol, (short) 0x00,
					(short) pbocpdol.length);
		} else {
			// contactless fci
			contactlessfci = fci;
			...
			Util.arrayCopy(cmdbuf, sTmp, qpbocpdol, (short) 0x00,
					(short) qpbocpdol.length);
		}
		...
		if (sOff != PBOCUtil.TAG_NOT_FOUND) {
			...
			sOff = PBOCUtil.findValueOffByTag(TAG_SECTION_PURCHASE_APP_ID, fci,
					sOff, sLen);
			// 0xDF61, 分段扣费应用标识
			if (sOff != PBOCUtil.TAG_NOT_FOUND) {
	...
	private void persoGPO(short dgi, byte[] cmdbuf, short sOff, short sLen) {
		...
		if (dgi == DGI_PERSO_9104) {
			...
			// copy AIP
			Util.arrayCopy(cmdbuf, (short) (sOff + 0x02), pbocGPO,
					(short) 0x00, (short) 0x02);
			// copy AFL
			Util.arrayCopy(cmdbuf, (short) (sOff + 0x06), pbocGPO,
					(short) 0x02, (short) (pbocGPO.length - 0x02));
		} else if (dgi == DGI_PERSO_9203) {
			// GPO response (EC)
			ecGPO = new byte[(short) (sLen - 0x04)];
			// copy AIP
			Util.arrayCopy(cmdbuf, (short) (sOff + 0x02), ecGPO, (short) 0x00,
					(short) 0x02);
			// copy AFL
			Util.arrayCopy(cmdbuf, (short) (sOff + 0x06), ecGPO, (short) 0x02,
					(short) (ecGPO.length - 0x02));
			...
			Util.arrayCopy(cmdbuf, sOff, qpbocGPO, (short) 0x00,
					(short) qpbocGPO.length);

			// GPO response (QPBOC)
			// get qPBOC AIP
			sValueOff = PBOCUtil.findValueOffByTag(TAG_AIP, cmdbuf, sOff, sLen);
			Util.arrayCopy(cmdbuf, sValueOff, paramBuf,
					PBOC_PARAM_OFF_QPBOC_AIP, (short) 0x02);
			...
			sQPBOCLastRecDGI = Util.makeShort((byte) (cmdbuf[sValueOff] >> 3),
					cmdbuf[(short) (sValueOff + 2)]);

			// if qPBOC exist 9F10
			sValueOff = PBOCUtil.findValueOffByTag(TAG_ISSUE_APP_DATA, cmdbuf,
					sOff, sLen);
			if (sValueOff != PBOCUtil.TAG_NOT_FOUND) {
				...
				if (sIssueAppData > sTmp) {
					sIssueAppData = (byte) (sTmp
							+ cmdbuf[(short) (sValueOff + 1 + sTmp)] + 1);
				}

				sQPBOCIssueAppDataLen = sIssueAppData;
				Util.arrayCopy(cmdbuf, (short) (sValueOff + 1),
						qpbocIssueAppData, (short) 0x00,
						(short) (cmdbuf[sValueOff] & 0x0FF));
			}
		}
	}
	...
	private void buildQPBOCARQCAACGPORsp(byte[] tmpBuf) {
		...
		tmpBuf[0x00] = 0x77;
		// append AIP
		sOff = Util.arrayCopy(qpbocGPO, (short) 0x00, tmpBuf, (short) 0x03,
				(short) 0x04);
		...
		sOff = PBOCUtil.appendTLV(TAG_2ND_TRACK_DATA, cardDataBuf,
				(short) (CARD_DATA_OFF_2ND_TRACK_DATA + 1),
				cardDataBuf[CARD_DATA_OFF_2ND_TRACK_DATA], tmpBuf, sOff);

		// append Issue application Data
		sOff = PBOCUtil.appendTLV(TAG_ISSUE_APP_DATA, qpbocIssueAppData,
				(short) 0x00, sQPBOCIssueAppDataLen, tmpBuf, sOff);
		...
		// append 产品标识信息
		sOff = PBOCUtil.appendTLV(TAG_PRODUCET_ID_INFO, cardDataBuf,
				CARD_DATA_OFF_PRODUCET_ID_INFO, (short) 0x10, tmpBuf, sOff);

		// append 应用PAN序列号
		sOff = PBOCUtil.appendTLV(TAG_APP_PAN_SEQUENCE_NO, cardDataBuf,
				CARD_DATA_OFF_PAN, (short) 0x01, tmpBuf, sOff);

		// append 卡片交易属性
		sOff = PBOCUtil.appendTLV(TAG_CARD_TRADE_ATTRIBUTE, cardDataBuf,
				CARD_DATA_OFF_CARD_TRADE_ATTRIBUTE, (short) 0x02, tmpBuf, sOff);
		sQPBOCARQCAACRspCardAttrOff = (short) (sOff - 0x02);

		// append 可用脱机消费金额
		if (isCPPReturnAvailableMoney) {
			sOff = PBOCUtil.appendTLV(TAG_AVAILABLE_OFFLINE_MONEY, cardDataBuf,
					CARD_DATA_OFF_AVAILABLE_OFFLINE_MONEY, (short) 0x06,
					tmpBuf, sOff);
		...
		// append 持卡人姓名
		sOff = PBOCUtil.appendTLV(TAG_CARD_HOLDER_NAME, cardDataBuf,
				(short) (CARD_DATA_OFF_CARD_HOLDER_NAME + 1),
				cardDataBuf[CARD_DATA_OFF_CARD_HOLDER_NAME], tmpBuf, sOff);
	...
	private void buildQPBOCTCGOBRsp(byte[] tmpBuf) {
		...
		if (PBOCUtil.isBitSet(tmpBuf, (short) 0x05, (short) 0x02)
				&& (sRSAKeyLen > 0x00) && (sRSAKeyLen <= 0x80)) {
			...
			sOff = Util.arrayFillNonAtomic(tmpBuf, sOff, sRSAKeyLen,
					(byte) 0x00);
		...
		if (isCPPReturnAvailableMoney) {
			...
			if ((!PBOCUtil.isBitSet(tmpBuf, (short) 0x05, (short) 0x02))
					|| (sRSAKeyLen <= 0x80)) {
				sOff = PBOCUtil.appendTLV(TAG_AVAILABLE_OFFLINE_MONEY,
						cardDataBuf, CARD_DATA_OFF_AVAILABLE_OFFLINE_MONEY,
						(short) 0x06, tmpBuf, sOff);
		...
		if (sRSAKeyLen > 0x7F) {
			...
			Util.arrayCopy(tmpBuf, (short) 0x03, tmpBuf, (short) 0x02,
					sRSAKeyLen);
			sOff--;
	...
	private void buildQPBOCGPORspTemplate(byte[] tmpBuf) {
		...
		if ((sSignatureLen > 0x80) && (sQPBOCSigDGI == 0x00)) {
			// create 0601 record
			...
			sRecOff = Util.setShort(record, sRecOff,
					TAG_AVAILABLE_OFFLINE_MONEY);
			record[sRecOff] = 0x06;
	...
	private void buildDDATemplate(byte[] tmpBuf) {
		...
		Util.arrayFillNonAtomic(tmpBuf, DDA_OFF_PADDING_BB, sPaddingLen,
				(byte) 0xBB);

		tmpBuf[(short) (sModuleLen - 0x01)] = (byte) 0xBC;

		ddaTemplate = new byte[sModuleLen];
		Util.arrayCopy(tmpBuf, (short) 0x00, ddaTemplate, (short) 0x00,
				sModuleLen);
	}
	 ...
	 *            PBOC/QPBOC FCI
	 * @param tag
	 *            TAG_LOG_ENTRY/TAG_CHARGE_LOG_ENTRY
	...
	private short getLogEntry(byte[] fci, short tag) {
		...
		sOff = PBOCUtil
				.findValueOffByTag(TAG_FCI_ISUSSER_DATA, fci, sOff, sLen);
		if (sOff != PBOCUtil.TAG_NOT_FOUND) {
			sLen = (short) (fci[(short) (sOff - 0x01)] & 0x00FF);
	...
	private void createLogFile() {
		...
		if ((logFormat != null) && (logEntry != INVALID_VALUE)) {
			...
			sLen = PBOCUtil.getValueLenByTLList(logFormat, (short) 0x00,
					(short) logFormat.length);
		...
		if ((chargelogFormat != null) && (logEntry != 0x00)) {
			sTmp = (short) (logEntry & 0x00FF);
			sLen = PBOCUtil.getValueLenByTLList(chargelogFormat, (short) 0x00,
					(short) chargelogFormat.length);
			// 4 byte record counter + 9F79/DF79 tag value 2 byte + before value
			// 6 byte + after value 6 byte
			sLen += 18;
			sTmp *= sLen;
	...
	private void bulidLogTemplate() {
		...
		while (sLogFormatOff < sLogFormatLen) {
			...
			if (bPBOC) {
				// find in CDOL1
				short sOff = PBOCUtil.findValuePosInTLList(sTag, cdol1,
						(short) 0x00, sCDOL1Len);
				if (sOff != PBOCUtil.TAG_NOT_FOUND) {
					...
					boolean bFind = true;
					sOff = PBOCUtil.findValuePosInTLList(sTag, cdol2,
							(short) 0x00, sCDOL2Len);
					if (sOff != PBOCUtil.TAG_NOT_FOUND) {
					...
					sOff = PBOCUtil.findValuePosInTLList(sTag, pbocpdol,
							(short) 0x00, sPDOLLen);
					if (sOff != PBOCUtil.TAG_NOT_FOUND) {
					...
					if (bQPBOC) {
						sOff = PBOCUtil.findValuePosInTLList(sTag, qpbocpdol,
								(short) 0x00, sQPDOLLen);
						if (sOff != PBOCUtil.TAG_NOT_FOUND) {
			...
			if (bQPBOC) {
				short sOff = PBOCUtil.findValuePosInTLList(sTag, qpbocpdol,
						(short) 0x00, sQPDOLLen);
				if (sOff != PBOCUtil.TAG_NOT_FOUND) {
	...
	private void appInit() {
		isCPPSupportECCheck = PBOCUtil.isBitSet(cardDataBuf,
				CARD_DATA_OFF_CARD_PLUS_PROCESS, CPP_SUPPORT_EC_CHECK);
		isCPPSupportECAndCTTACheck = PBOCUtil.isBitSet(cardDataBuf,
				CARD_DATA_OFF_CARD_PLUS_PROCESS, CPP_SUPPORT_EC_AND_CTTA_CHECK);
		isCPPSupportECOrCTTACheck = PBOCUtil.isBitSet(cardDataBuf,
				CARD_DATA_OFF_CARD_PLUS_PROCESS, CPP_SUPPORT_EC_OR_CTTA_CHECK);
		isCPPSupportNewCardCheck = PBOCUtil.isBitSet(cardDataBuf,
				CARD_DATA_OFF_CARD_PLUS_PROCESS, CPP_SUPPORT_NEW_CARD_CHECK);
		isCPPSupportPINCheck = PBOCUtil.isBitSet(cardDataBuf,
				CARD_DATA_OFF_CARD_PLUS_PROCESS, CPP_SUPPORT_PIN_CHECK);
		isCPPAllowCoinNotMatchOffline = PBOCUtil.isBitSet(cardDataBuf,
				CARD_DATA_OFF_CARD_PLUS_PROCESS,
				CPP_ALLOW_COIN_NOT_MATCH_OFFLINE);
		isCPPFstContactPBOCOnline = PBOCUtil.isBitSet(cardDataBuf,
				CARD_DATA_OFF_CARD_PLUS_PROCESS, CPP_FST_CONTACT_PBOC_ONLINE);
		isCPPReturnAvailableMoney = PBOCUtil.isBitSet(cardDataBuf,
				CARD_DATA_OFF_CARD_PLUS_PROCESS, CPP_RETURN_AVAILABLE_MONEY);
		isCPPSupportPrePay = PBOCUtil.isBitSet(cardDataBuf,
				CARD_DATA_OFF_CARD_PLUS_PROCESS, CPP_PRE_PAY);
		isCPPNotAllowCoinNotMatchTrade = PBOCUtil.isBitSet(cardDataBuf,
				CARD_DATA_OFF_CARD_PLUS_PROCESS,
				CPP_NOT_ALLOW_COIN_NOT_MATCH_TRADE);
		isCPPNewCardOnlySupportOffline = PBOCUtil.isBitSet(cardDataBuf,
				CARD_DATA_OFF_CARD_PLUS_PROCESS,
				CPP_NEWCARD_ONLY_SUPPORT_OFFLINE);
		isCPPQPBOCSupportTradeLog = PBOCUtil.isBitSet(cardDataBuf,
				CARD_DATA_OFF_CARD_PLUS_PROCESS, CPP_QPBOC_SUPPORT_LOG);
		isCPPMatchCoinTradeSupportPIN = PBOCUtil.isBitSet(cardDataBuf,
				CARD_DATA_OFF_CARD_PLUS_PROCESS,
				CPP_MATCH_COIN_TRADE_SUPPORT_PIN);
		isCPPNotMatchCoinTradeSupportPIN = PBOCUtil.isBitSet(cardDataBuf,
				CARD_DATA_OFF_CARD_PLUS_PROCESS,
				CPP_NOT_MATCH_COIN_TRADE_SUPPORT_PIN);
		isCPPNotMatchCoinTradeReqCVM = PBOCUtil.isBitSet(cardDataBuf,
				CARD_DATA_OFF_CARD_PLUS_PROCESS,
				CPP_NOT_MATCH_COIN_TRADE_REQUEST_CVM);
		isCPPSupportSign = PBOCUtil.isBitSet(cardDataBuf,
				CARD_DATA_OFF_CARD_PLUS_PROCESS, CPP_SUPPORT_SIGN);

		bCTTAULNotExist = PBOCUtil.isAllZero(cardDataBuf,
				CARD_DATA_OFF_TOTAL_CARD_MONEY_UPLIMIT, (short) 0x06);
		bIsQPBOCSupportDDA = PBOCUtil.isBitSet(qpbocGPO, (short) 0x02,
				AIP_SUPPORT_OFF_DDA);
		...
		if (FUNCTION_FOR_TIANYU) {
			pdolValue = JCSystem.makeTransientByteArray(pdolValueLen,
					JCSystem.CLEAR_ON_RESET);
		} else {
			pdolValue = JCSystem.makeTransientByteArray(pdolValueLen,
					JCSystem.CLEAR_ON_DESELECT);
		...
		if (sQPBOCIssueAppDataLen == 0x00) {
			...
			Util.arrayCopy(pbocIssueAppData, (short) 0x00, qpbocIssueAppData,
					(short) 0x00, sQPBOCIssueAppDataLen);
		}
		...
		if (index < RECORD_OBJECT_SIZE) {
			...
			short sValueOff = PBOCUtil.findValueOffByTag(TAG_CARD_AUTH_DATA,
					rec, sOff, sLen);
			if (sValueOff != PBOCUtil.TAG_NOT_FOUND) {
				sValueOff -= 0x03;
				...
				tmp = Util.arrayCopy(rec, sOff, newRec, tmp,
						(short) (sValueOff - sOff));
				if ((short) (sValueOff + 0x0B) < (short) rec.length) {
					Util.arrayCopy(rec, (short) (sValueOff + 0x0B), newRec,
							tmp, (short) (rec.length - sValueOff - 0x0B));
				}
	...
	private short findExtendFile(byte sfi) {
		...
		for (short i = 0x00; i < size; i++) {
			...
			if ((file != null) && (file[EXT_APP_FILE_OFF_SFI] == sfi)) {
				return i;
			}
		}
	 ...
	 *            perso data lenth.
	 */
	private void persoExtendFile(SecureChannel sc, short dgi, byte[] cmdbuf,
			short sOff, short sLen) {
		short i = sOff;
		...
		if (dgi == DGI_PERSO_A001) {
			...
			// item is 1 byte sfi + 2 byte ID + 6 byte pre-authorization money =
			// 9 byte
			// 3 item = 3 * 9 = 27
			...
			short index = 0x00;
			while (i < sLen) {
				Util.arrayCopy(cmdbuf, i, (byte[]) extAppFiles[index++],
						EXT_APP_FILE_OFF_OPEN_KEY, (short) 0x10);
			...
			short index = 0x00;
			while (i < sLen) {
				Util.arrayFillNonAtomic(cmdbuf, (short) 0x00, (short) 0x08,
						(byte) 0x00);

				tripleDesKey.setKey((byte[]) extAppFiles[index++],
						EXT_APP_FILE_OFF_OPEN_KEY);
				cipherECBEncrypt.doFinal(cmdbuf, (short) 0x00, (short) 0x08,
						cmdbuf, (short) 0x00);
				if (Util.arrayCompare(cmdbuf, (short) 0x00, cmdbuf, i,
						(short) 0x03) != 0x00) {
					ISOException.throwIt(ISO7816.SW_WRONG_DATA);
				}
	...
	private void onStoreData(SecureChannel sc, byte[] apduBuf) {
		...
		if (blockNum == 0x00) {
			Util.arrayFillNonAtomic(qpbocIssueAppData, (short) 0x00,
					(short) qpbocIssueAppData.length, (byte) 0x00);
		}
		...
		if ((sfi > 0x00) && (sfi < 0x1F)) {
			...
			case DGI_PERSO_8000:
				...
				Util.arrayCopy(apduBuf, sOff, paramBuf, PBOC_PARAM_OFF_APP_KEY,
						(short) 0x30);
				break;
			// dCVN key
			case DGI_PERSO_8001:
			...
			case DGI_PERSO_8010:
				...
				Util.arrayCopy(apduBuf, sOff, paramBuf,
						PBOC_PARAM_OFF_PIN_VALUE, (short) 0x06);
				break;
			// RSA Key
			case DGI_PERSO_8201:
			case DGI_PERSO_8202:
			...
			case DGI_PERSO_9000:
				...
				Util.arrayFillNonAtomic(apduBuf, (short) 0x40, (short) 0x08,
						(byte) 0x00);

				tripleDesKey.setKey(paramBuf, PBOC_PARAM_OFF_APP_KEY);
				cipherECBEncrypt.doFinal(apduBuf, (short) 0x40, (short) 0x08,
						apduBuf, (short) 0x50);
				if (Util.arrayCompare(apduBuf, (short) 0x50, apduBuf, sOff,
						(short) 0x03) != 0x00) {
					ISOException.throwIt(ISO7816.SW_WRONG_DATA);
				}
				...
				cipherECBEncrypt.doFinal(apduBuf, (short) 0x40, (short) 0x08,
						apduBuf, (short) 0x50);
				if (Util.arrayCompare(apduBuf, (short) 0x50, apduBuf,
						(short) (sOff + 0x03), (short) 0x03) != 0x00) {
					ISOException.throwIt(ISO7816.SW_WRONG_DATA);
				}
				...
				cipherECBEncrypt.doFinal(apduBuf, (short) 0x40, (short) 0x08,
						apduBuf, (short) 0x50);
				if (Util.arrayCompare(apduBuf, (short) 0x50, apduBuf,
						(short) (sOff + 0x06), (short) 0x03) != 0x00) {
					ISOException.throwIt(ISO7816.SW_WRONG_DATA);
				}
				break;
			// PIN Max Retry Counter
			case DGI_PERSO_9010:
				...
				Util.arrayCopy(apduBuf, sOff, paramBuf,
						PBOC_PARAM_OFF_PIN_LEFT_CNTR, (short) 0x02);
				break;
			// Select FCI(PBOC)
			case DGI_PERSO_9102:
				// Select FCI(qPBOC)
			...
			case DGI_PERSO_9200:
				...
				if (sIssueAppData > sTmp) {
					sIssueAppData = (byte) (sTmp
							+ apduBuf[(short) (sOff + 1 + sTmp)] + 1);
				}

				pbocIssueAppData = new byte[sIssueAppData];
				Util.arrayCopy(apduBuf, (short) (sOff + 1), pbocIssueAppData,
						(short) 0x00, (short) (apduBuf[sOff] & 0x0FF));
				break;
			case DGI_PERSO_A001:
			case DGI_PERSO_8020:
			case DGI_PERSO_9020:
	...
	private boolean isECTrade(boolean bType) {
		...
		if (sTradeCoinOff != INVALID_VALUE) {
			if (Util.arrayCompare(pdolValue, sTradeCoinOff, cardDataBuf,
					CARD_DATA_OFF_APPCOINCODE, (short) 0x02) == 0x00) {
				bIsECSecond = false;
			} else if (Util.arrayCompare(pdolValue, sTradeCoinOff, cardDataBuf,
					CARD_DATA_OFF_EC_SECOND_APP_COIN_CODE, (short) 0x02) == 0x00) {
				bIsECSecond = true;
			} else {
				return false;
			}
		...
		if ((sECSupportOff == INVALID_VALUE) || (pdolValue[sECSupportOff] != 1)) {
			return false;
		}

		// 3. 授权金额不超过电子现金余额
		if (PBOCUtil.arrayCompare(pdolValue, sTradeMoneyOff,
				abyCurTradeCardData,
				bIsECSecond ? CARD_DATA_OFF_EC_SECOND_BALANCE
						: CARD_DATA_OFF_EC_BALANCE, (short) 0x06) == 1) {
			return false;
		}

		// 4. 授权金额不超过电子现金单笔交易限额
		if (PBOCUtil.arrayCompare(pdolValue, sTradeMoneyOff, cardDataBuf,
				bIsECSecond ? CARD_DATA_OFF_EC_SECOND_SINGLE_TRADE_LIMIT
						: CARD_DATA_OFF_SINGLE_CARD_LIMIT, (short) 0x06) == 1) {
			return false;
		}
	...
	private void calAvailableMoney() {
		...
		if (isCPPSupportECCheck) {
			...
			Util.arrayCopyNonAtomic(abyCurTradeCardData, sOff,
					abyCurTradeCardData, CARD_DATA_OFF_AVAILABLE_OFFLINE_MONEY,
					(short) 0x06);
		} else if (isCPPSupportECAndCTTACheck) {
			// 可用脱机余额等于CTTAUL/CTTAL - CTTA
			if (bCTTAULNotExist) {
				// CTTAUL不存在, 使用CTTAL
				PBOCUtil.arrayDecSub(cardDataBuf,
						CARD_DATA_OFF_TOTAL_CARD_MONEY_LIMIT,
						abyCurTradeCardData,
						CARD_DATA_OFF_TOTAL_OFFILINE_MONEY,
						abyCurTradeCardData,
						CARD_DATA_OFF_AVAILABLE_OFFLINE_MONEY);
			} else {
				PBOCUtil.arrayDecSub(cardDataBuf,
			...
			PBOCUtil.arrayDecAdd(abyCurTradeCardData,
					CARD_DATA_OFF_AVAILABLE_OFFLINE_MONEY, abyCurTradeCardData,
					CARD_DATA_OFF_EC_BALANCE, abyCurTradeCardData,
					CARD_DATA_OFF_AVAILABLE_OFFLINE_MONEY);
		} else {
			// 用0填充
			Util.arrayFillNonAtomic(abyCurTradeCardData,
					CARD_DATA_OFF_AVAILABLE_OFFLINE_MONEY, (short) 0x06,
					(byte) 0x00);
		}
	}
	 ...
	 * @param tmpBuf
	 *            temp buffer
	 * @param bIsTradeCoinMatch
	 *            is trade coin match
	 * @param bIsECSecond
	 *            is secord coin ec trade
	 * @return
	 */
	private byte qPBOCCardRiskManager(byte[] tmpBuf, boolean bIsTradeCoinMatch,
			boolean bIsECSecond) {

		/**
		 * 1. 设置货币匹配或不匹配 货币被比较一次同时保存结果。进行如下处理：
		...
		boolean bIsOnlySupportOffline = PBOCUtil.isBitSet(pdolValue,
				sQPDOLVTerminalTradeAttrOff,
				TER_TRADE_ATT_OFF_SUPPORT_ONLY_OFFLINE);
		...
		/**
		 * 2. 终端仅支持脱机 如果终端仅支持脱机，跳过联机请求检查 如果终端仅支持脱机（终端交易属性，第 1 字节第 4
		 * 位=‘1’），卡片需要尝试脱机处理
		 */
		if (bIsOnlySupportOffline) {
			// 将仅脱机终端位（内部卡指示器）设置为‘1’
			// abyCardInterIndicators[CARD_INTER_OFF_ONLY_OFFLINE] =
			// CARD_INTER_ONLY_OFFLINE;

			// 如果上次联机 ATC 寄存器为 0，并且如果是新卡且终端仅支持脱机（卡片附加处理的第2 字节第 6 位=‘1’），就拒绝交易
			if ((Util
					.getShort(abyCurTradeCardData, CARD_DATA_OFF_PREONLINE_ATC) == 0x00)
			...
			if (isCPPSupportPINCheck) {
				...
				if ((paramBuf[PBOC_PARAM_OFF_PIN_MAX_CNTR] != 0x00)
						&& (paramBuf[PBOC_PARAM_OFF_PIN_LEFT_CNTR] == 0x00)) {
					PBOCUtil.setBit(abyPBOCTradeSession,
							TRADE_SESSION_DATA_OFF_CVR, CVR_OFF_PIN_BLOCKED);
					return TRADE_RESULT_AAC;
				}
			}
			...
			if (PBOCUtil.isBitSet(pdolValue, sQPDOLVTerminalTradeAttrOff,
					TER_TRADE_ATT_OFF_SUPPORT_REQ_CVM)
					|| (bIsTradeCoinMatch && (PBOCUtil.arrayCompare(pdolValue,
							sQPDOLTradeAuthMoneyOff, cardDataBuf, sCVMLimitOff,
							(short) 0x06) == 1))
				...
				if (PBOCUtil.isBitSet(pdolValue, sQPDOLVTerminalTradeAttrOff,
						TER_TRADE_ATT_OFF_SUPPORT_SIGN) && isCPPSupportSign) {
					PBOCUtil.setBit(abyCurTradeCardData,
							CARD_DATA_OFF_CARD_TRADE_ATTRIBUTE,
							CARD_TRADE_ATTR_NEED_SIGN);
				} else {
			...
			/**
			 * 3. 终端或卡请求 CVM
			 * 终端可以请求CVM（总是或者对超过终端CVM请求上限的交易）。卡同样也可以请求CVM。目前qPBOC支持两种方式验证持卡人
			 * ：联机PIN和签名 如果卡或终端请求CVM，而卡不支持任何一种终端在终端交易属性中指明的CVM，则交易将被终止
			...
			// 3. 如果终端交易属性的 CVM 请求位（第 2 字节第 7 位）为‘0’,匹配货币位＝‘0’，且不匹配货币交易卡片请求 CVM
			// 位=‘1’（卡片附加处理的第 3字节第 6 位）
			if (PBOCUtil.isBitSet(pdolValue, sQPDOLVTerminalTradeAttrOff,
					TER_TRADE_ATT_OFF_SUPPORT_REQ_CVM)
					|| (bIsTradeCoinMatch && (PBOCUtil.arrayCompare(pdolValue,
							sQPDOLTradeAuthMoneyOff, cardDataBuf, sCVMLimitOff,
				...
				// 表示卡和终端均支持联机 PIN
				if (PBOCUtil.isBitSet(pdolValue, sQPDOLVTerminalTradeAttrOff,
						TER_TRADE_ATT_OFF_SUPPORT_ONLINE_PIN)
						&& ((bIsTradeCoinMatch && isCPPMatchCoinTradeSupportPIN) || (!bIsTradeCoinMatch && isCPPNotMatchCoinTradeSupportPIN))) {
					// 卡要将卡交易属性（标签“9F6C”，第 1 字节第 8 位）设置为‘1’，并请求联机处理
					PBOCUtil.setBit(abyCurTradeCardData,
							CARD_DATA_OFF_CARD_TRADE_ATTRIBUTE,
							CARD_TRADE_ATTR_NEED_ONLINE_PIN);
					return TRADE_RESULT_ARQC;
				} else if (PBOCUtil.isBitSet(pdolValue,
						sQPDOLVTerminalTradeAttrOff,
						TER_TRADE_ATT_OFF_SUPPORT_SIGN)
						&& isCPPSupportSign) {
			...
			/**
			 * 4. 检查联机处理请求 卡片和终端可以基于交易条件请求联机处理。如果先前的检查没有指示需要联机处理，或终止非接触交易，
			 * 执行该检查决定是否存在其它的条件导致联机处理
			 */
			...
			// 则卡片应请求联机处理
			if (PBOCUtil.isBitSet(pdolValue, sQPDOLVTerminalTradeAttrOff,
					TER_TRADE_ATT_OFF_SUPPORT_REQ_ARQC)
					|| (!bIsTradeCoinMatch && (!isCPPAllowCoinNotMatchOffline))) {
				return TRADE_RESULT_ARQC;
			}

			// 如果支持新卡检查（卡片附加处理的第 1 字节第5 位= ‘1’ ）同时上次联机 ATC
			// 寄存器为零（新卡没完成联机处理），则卡应请求联机处理
			if (isCPPSupportNewCardCheck
					&& Util.getShort(abyCurTradeCardData,
							CARD_DATA_OFF_PREONLINE_ATC) == 0x00) {
				// 将 CVR 的第 3 字节第 5 位设置为‘1’（新卡）
				PBOCUtil.setBit(abyPBOCTradeSession,
						TRADE_SESSION_DATA_OFF_CVR, CVR_OFF_NEW_CARD);
				return TRADE_RESULT_ARQC;
			}

			// 如果支持 PIN 尝试超过检查（卡片附加处理的第 1 字节第4 位=‘1’）同时脱机 PIN
			// 尝试计数器（标签“9F17”）存在并等于零（没有剩余的 PIN 尝试），
			// 则卡应请求联机处理
			if (isCPPSupportPINCheck
		...
		/**
		 * 5. 脱机货币检查 当交易货币匹配应用货币，执行脱机消费检查。如果货币不匹配，跳过这些检查并执行不匹配货币处理
		 * 检查处理是匹配还是非匹配货币，以及是否支持脱机消费检查类型的相应检查
		 * 小额检查、小额和CTTA检查、小额或CTTA检查是qPBOC的三种检查脱机消费的方法
		 */
		if (bIsTradeCoinMatch) {
			Util.arrayCopyNonAtomic(abyCurTradeCardData, sECBalanceOff, tmpBuf,
			...
			if (extAppType == EXTEND_APP_TRADE_TYPE_SP) {
				...
				if (!PBOCUtil.isAllZero(cardDataBuf,
						CARD_DATA_OFF_SP_DEDUCTION_LIMIT, (short) 0x06)) {
					PBOCUtil.arrayDecAdd(tmpBuf, (short) 0x00, cardDataBuf,
							CARD_DATA_OFF_SP_DEDUCTION_LIMIT, tmpBuf,
							(short) 0x00);
					PBOCUtil.arrayDecSub(tmpBuf, (short) 0x00,
							abyCurTradeCardData,
							CARD_DATA_OFF_SP_DEDUCTION_MONEY, tmpBuf,
							(short) 0x00);
					...
					if (PBOCUtil.arrayCompare(tmpBuf, (short) 0x00, pdolValue,
							sQPDOLTradeAuthMoneyOff, (short) 0x06) == -1) {
						Util.arrayCopyNonAtomic(abyCurTradeCardData,
								sECBalanceOff, tmpBuf, (short) 0x00,
								(short) 0x06);
					}
				}
				...
				PBOCUtil.arrayDecAdd(tmpBuf, (short) 0x00, abyPBOCTradeSession,
						TRADE_SESSION_DATA_OFF_PRE_AUTH_MONEY, tmpBuf,
						(short) 0x00);
				if (PBOCUtil.arrayCompare(tmpBuf, (short) 0x00, pdolValue,
						sQPDOLTradeAuthMoneyOff, (short) 0x06) == -1) {
					Util.arrayCopyNonAtomic(abyCurTradeCardData, sECBalanceOff,
							tmpBuf, (short) 0x00, (short) 0x06);
				}
			}
			 ...
			 * 执行这个选项能够来提供等于电子现金余额的可用脱机消费金额 如果支持小额检查（卡片附加处理的第 1 字节第 8
			 * 位=‘1’），则电子现金余额就是总的脱机，接着执行小额检查
			 */
			if (isCPPSupportECCheck) {
				abyPBOCTradeSession[TRADE_SESSION_DATA_OFF_QPBOC_OFFLINE_CHECK] = QPBOC_OFFLINE_CHECK_TYPE_EC_CHECK;

				/**
				 * 10. 小额检查 检查交易是否能够脱机处理
				 * 如果授权金额（标签“9F02”）小于或等于电子现金单笔交易限额，同时在交易的电子现金余额中有足够的脱机消费可用金额
				 * ，则交易进行脱机处理 否则（即如果授权金额大于电子现金单笔交易限额或者交易没有足够的脱机消费可用金额）：
				 * 如果可以联机处理，则卡片请求联机处理 如果不能联机处理，则卡片请求拒绝
				 */
				...
				if (bIsOnlySupportOffline) {
					if ((PBOCUtil.arrayCompare(pdolValue,
							sQPDOLTradeAuthMoneyOff, tmpBuf, (short) 0x00,
							(short) 0x06) == 1)
							|| (PBOCUtil.arrayCompare(pdolValue,
									sQPDOLTradeAuthMoneyOff, cardDataBuf,
									sSingleCardLimitOff, (short) 0x06) == 1)) {
						// 设置 CVR 的第 3 字节第 6 位为‘1’（频度检查计数器超过）
						PBOCUtil.setBit(abyPBOCTradeSession,
								TRADE_SESSION_DATA_OFF_CVR,
								CVR_OFF_EXCEED_FREQ_CHECK);
						return TRADE_RESULT_AAC;
					}
				} else {
					...
					// 电子现金重置阈值加上授权金额
					PBOCUtil.arrayDecAdd(cardDataBuf, sECResetThresholdOff,
							pdolValue, sQPDOLTradeAuthMoneyOff, tmpBuf,
							(short) 0x06);
					if ((PBOCUtil.arrayCompare(pdolValue,
							sQPDOLTradeAuthMoneyOff, cardDataBuf,
							sSingleCardLimitOff, (short) 0x06) == 1)
							|| (PBOCUtil.arrayCompare(tmpBuf, (short) 0x06,
									tmpBuf, (short) 0x00, (short) 0x06) == 1)) {
						// 设置 CVR 的第 3 字节第 6 位为‘1’（频度检查计数器超过）
						PBOCUtil.setBit(abyPBOCTradeSession,
								TRADE_SESSION_DATA_OFF_CVR,
								CVR_OFF_EXCEED_FREQ_CHECK);
			...
			/**
			 * 7. 匹配货币交易的小额和 CTTA 检查 此部分检查CTTA是否超过累计脱机交易金额上限（CTTAUL）
			 * 或者在CTTAUL不存在的情况下是否超过累计脱机交易金额限制数CTTAL
			 * 如果CTTA可用资金——CTTAUL（如果不存在用CTTAL）减去CTTA是可用的，同样会检查交易金额是否超过电子现金单笔交易限额
			 * 只有当小额和CTTA检查通过时，脱机交易才会发生 继续进行的步骤见11——小额和CTTA检查
			 */
			if (isCPPSupportECAndCTTACheck) {
				...
				/**
				 * 11. 小额和CTTA 检查 检查交易是否能够脱机进行处理 如果授权金额（标签 “9F02”
				 * ）小于或等于电子现金单笔交易限额， 并且交易的电子现金余额和CTTA可用资金都有足够的脱机资金，则交易脱机处理。
				 * 否则[即，如果授权金额（标签“9F02”）大于电子现金单笔交易限额或者交易没有足够的可用脱机消费金额]：
				 * 如果可以联机处理，则卡片请求联机处理 如果不能联机，则卡片请求拒绝
				 */
				if (bCTTAULNotExist) {
					// CTTAUL不存在, 使用CTTAL
					PBOCUtil.arrayDecSub(cardDataBuf,
							CARD_DATA_OFF_TOTAL_CARD_MONEY_LIMIT,
							abyCurTradeCardData,
							CARD_DATA_OFF_TOTAL_OFFILINE_MONEY, tmpBuf,
							(short) 0x06);
				} else {
					PBOCUtil.arrayDecSub(cardDataBuf,
							CARD_DATA_OFF_TOTAL_CARD_MONEY_UPLIMIT,
				...
				// 设置脱机可用余额
				Util.arrayCopyNonAtomic(tmpBuf, (short) 0x06,
						abyCurTradeCardData,
						CARD_DATA_OFF_AVAILABLE_OFFLINE_MONEY, (short) 0x06);
				...
				if (bIsOnlySupportOffline) {
					/**
					 * 1. 授权金额（标签“9F02”）大于电子现金余额 2. 授权金额大于电子现金单笔交易限额 3. 授权金额加上
					 * CTTA 大于 CTTAUL（或者是 CTTAL 如果 CTTAUL 不存在）
					 */
					if ((PBOCUtil.arrayCompare(pdolValue,
							sQPDOLTradeAuthMoneyOff, cardDataBuf,
							CARD_DATA_OFF_SINGLE_CARD_LIMIT, (short) 0x06) == 1)
							|| (PBOCUtil.arrayCompare(pdolValue,
									sQPDOLTradeAuthMoneyOff, tmpBuf,
									(short) 0x00, (short) 0x06) == 1)
							|| (PBOCUtil.arrayCompare(pdolValue,
									sQPDOLTradeAuthMoneyOff, tmpBuf,
									(short) 0x06, (short) 0x06) == 1)) {
						// 设置 CVR 的第 3 字节第 6 位为‘1’（频度检查计数器超过）
						PBOCUtil.setBit(abyPBOCTradeSession,
								TRADE_SESSION_DATA_OFF_CVR,
								CVR_OFF_EXCEED_FREQ_CHECK);
					...
					/**
					 * 1. 授权金额（标签“9F02”）大于电子现金单笔交易限额（如果存在，标签“9F78”） 2.
					 * 授权金额（标签“9F02”）大于电子现金余额（标签“9F79”）减去电子现金重置阈值（标签“9F6D”） 3.
					 * 授权金额（标签“9F02”）加上CTTA 大于 CTTAUL/CTTAL（标签“9F54”）
					 */

					// 电子现金重置阈值加上授权金额
					PBOCUtil.arrayDecAdd(cardDataBuf,
							CARD_DATA_OFF_EC_RESET_THRESHOLD, pdolValue,
							sQPDOLTradeAuthMoneyOff, tmpBuf, (short) 12);

					if ((PBOCUtil.arrayCompare(pdolValue,
							sQPDOLTradeAuthMoneyOff, cardDataBuf,
							CARD_DATA_OFF_SINGLE_CARD_LIMIT, (short) 0x06) == 1)
							|| (PBOCUtil.arrayCompare(tmpBuf, (short) 12,
									tmpBuf, (short) 0x00, (short) 0x06) == 1)
							|| (PBOCUtil.arrayCompare(pdolValue,
									sQPDOLTradeAuthMoneyOff, tmpBuf,
									(short) 0x06, (short) 0x06) == 1)) {
			 ...
			 * 只有小额或者CTTA资金任一可用，脱机处理才会发生 如果支持小额或 CTTA 检查（卡片附加处理的第 1 字节第 6
			 * 位=‘1’），则脱机资金应在小额或者 CTTA 中可用 继续进行的步骤见12——小额或CTTA检查
			 */
			if (isCPPSupportECOrCTTACheck) {
				...
				/**
				 * 12. 小额或CTTA 检查 检查交易能否脱机处理
				 * 如果授权金额（标签“9F02”）小于或等于单笔交易限额，并且电子现金余额或者CTTA中有足够的脱机资金
				 * ，那么交易可以脱机处理。
				 * 否则（也即如果授权金额（标签“9F02”）大于电子现金单笔交易限额或者没有足够的可用脱机消费金额）：
				 * 如果允许联机交易，那么卡片请求联机处理 如果不允许联机交易，那么卡片将请求拒绝
				...
				// 设置脱机可用余额,
				// 可用脱机消费金额（标签“9F5D”）的值设为电子现金余额加上CTTAUL（或者是CTTAL如果CTTAUL不存在），再减去CTTA
				PBOCUtil.arrayDecAdd(tmpBuf, (short) 0x06, abyCurTradeCardData,
						CARD_DATA_OFF_EC_BALANCE, abyCurTradeCardData,
						CARD_DATA_OFF_AVAILABLE_OFFLINE_MONEY);
				...
				if (bIsOnlySupportOffline) {
					...
					if ((PBOCUtil.arrayCompare(pdolValue,
							...
							|| ((PBOCUtil.arrayCompare(pdolValue,
									sQPDOLTradeAuthMoneyOff, tmpBuf,
									(short) 0x00, (short) 0x06) == 1) && (PBOCUtil
									.arrayCompare(pdolValue,
											sQPDOLTradeAuthMoneyOff, tmpBuf,
											(short) 0x06, (short) 0x06) == 1))) {
						// 设置 CVR 的第 3 字节第 6 位为‘1’（频度检查计数器超过）
						PBOCUtil.setBit(abyPBOCTradeSession,
					...
					// 2. 如果授权金额（标签 “9F02” ）大于电子现金余额（标签 “9F79” ），并且授权金额（标签
					// “9F02” ）加上 CTTA（无标签）大于 CTTAUL/CTTAL（标签“9F54”）
					// 联机交易
					if ((PBOCUtil.arrayCompare(pdolValue,
							sQPDOLTradeAuthMoneyOff, cardDataBuf,
							CARD_DATA_OFF_SINGLE_CARD_LIMIT, (short) 0x06) == 1)
			...
			/**
			 * 13. 脱机下的货币不匹配 如果应用货币与交易货币不匹配，要检查这些交易的上限是否超额
			 */
			...
			if (sInterCoinOffLineATC >= sCoinOffLineTradeLimit) {
				...
				PBOCUtil.setBit(abyPBOCTradeSession,
						TRADE_SESSION_DATA_OFF_CVR, CVR_OFF_EXCEED_FREQ_CHECK);
	 ...
	 * 
	 * @param issueAppData
	 *            issue application data buffer
	 * @param sOff
	 *            issue application data buffer offset
	 * @param sIssueLen
	 *            issue application data length
	 */
	private void generateIssueAppData(byte[] issueAppData, short sOff,
			short sIssueLen) {
		// copy CVR
		Util.arrayCopyNonAtomic(abyPBOCTradeSession,
				TRADE_SESSION_DATA_OFF_CVR, issueAppData,
				(short) (sOff + 0x04), (short) 0x03);
		...
		if (sIssueLen > sLen) {
			...
			case 0x01:
				...
				Util.arrayCopyNonAtomic(abyCurTradeCardData,
						(short) (sECOff + 0x01), issueAppData, sTmp,
						(short) 0x05);
				sLen = 0x05;
				break;
			case 0x02:
				// 累计交易总金额(CTTA)低5个字节
				Util.arrayCopyNonAtomic(abyCurTradeCardData,
						(short) (CARD_DATA_OFF_TOTAL_OFFILINE_MONEY + 0x01),
						issueAppData, sTmp, (short) 0x05);
				sLen = 0x05;
				break;
			case 0x03:
				// 电子现金余额低5个字节和CTTA低5个字节
				Util.arrayCopyNonAtomic(abyCurTradeCardData,
						(short) (CARD_DATA_OFF_EC_BALANCE + 0x01),
						issueAppData, sTmp, (short) 0x05);
				Util.arrayCopyNonAtomic(abyCurTradeCardData,
						(short) (CARD_DATA_OFF_TOTAL_OFFILINE_MONEY + 0x01),
						issueAppData, (short) (sTmp + 0x05), (short) 0x05);
				sLen = 10;
				break;
			case 0x04:
				...
				Util.arrayCopyNonAtomic(abyCurTradeCardData,
						(short) (CARD_DATA_OFF_TOTAL_OFFILINE_MONEY + 0x01),
						issueAppData, sTmp, (short) 0x05);
				Util.arrayCopyNonAtomic(cardDataBuf,
						(short) (CARD_DATA_OFF_TOTAL_CARD_MONEY_LIMIT + 0x01),
						issueAppData, (short) (sTmp + 0x05), (short) 0x05);
				sLen = 10;
				break;
			case 0x05:
				// 可用脱机消费金额低5个字节
				Util.arrayCopyNonAtomic(abyCurTradeCardData,
						(short) (CARD_DATA_OFF_AVAILABLE_OFFLINE_MONEY + 0x01),
						issueAppData, sTmp, (short) 0x05);
				sLen = 0x05;
				break;
			default:
			...
			Util.arrayFillNonAtomic(sessionKey, (short) 0x00, (short) 0x10,
					(byte) 0x00);
			...
			tripleDesKey.setKey(paramBuf, PBOC_PARAM_OFF_MAC_KEY);
			cipherECBEncrypt.doFinal(sessionKey, (short) 0x00, (short) 0x10,
					sessionKey, (short) 0x00);
			...
			// Data
			Util.arrayCopyNonAtomic(issueAppData, sTmp, sessionKey,
					(short) 0x02, sLen);
			...
			signMac.sign(sessionKey, (short) 0, sCalData, sessionKey,
					(short) 0x00);

			Util.arrayCopyNonAtomic(sessionKey, (short) 0x00, issueAppData,
					(short) (sTmp + sLen), (short) 0x04);
		}
	}
	...
	private void generateAppCipher(byte[] cdolValue) {
		Util.arrayFillNonAtomic(sessionKey, (short) 0x00, (short) 0x10,
				(byte) 0x00);
		Util.arrayCopyNonAtomic(cardDataBuf, CARD_DATA_OFF_ATC, sessionKey,
				(short) 0x06, (short) 0x02);
		Util.arrayCopyNonAtomic(sessionKey, (short) 0x06, sessionKey,
				(short) 14, (short) 0x02);
		...
		if (pbocIssueAppData[0x02] == AC_VERSION_01) {
			...
			// 卡片参与应用密文计算的数据
			// 2 byte, AIP
			signMac.update(abyPBOCTradeSession, TRADE_SESSION_DATA_OFF_AIP,
					(short) 0x02);
			// 2 byte, ATC
			...
			signMac.sign(abyPBOCTradeSession, TRADE_SESSION_DATA_OFF_CVR,
					(short) 0x03, abyPBOCTradeSession,
					TRADE_SESSION_DATA_OFF_AC);
		} else {
			// 密文版本号17
			...
			// 发卡行应用数据第五个字节
			signMac.sign(abyPBOCTradeSession, TRADE_SESSION_DATA_OFF_CVR,
					(short) 0x01, abyPBOCTradeSession,
					TRADE_SESSION_DATA_OFF_AC);
		}
	}
	...
	private short qPBOCGPOProcess(byte[] apduBuf) {
		...
		if (extAppType == EXTEND_APP_TRADE_TYPE_OP) {
			// FORT BCTC testcase PRSS002, not read Extend Application File and
			// GPO command give a valid Extend Application Trade Type Value
			...
			if (!getPreAuthTradeMoney(abyPBOCTradeSession,
					TRADE_SESSION_DATA_OFF_PRE_AUTH_MONEY)) {
		...
		if (Util.arrayCompare(pdolValue, sQPDOLTradeCoinCodeOff, cardDataBuf,
				CARD_DATA_OFF_APPCOINCODE, (short) 0x02) == 0x00) {
			bIsTradeCoinMatch = true;
		} else if ((Util.arrayCompare(pdolValue, sQPDOLTradeCoinCodeOff,
				cardDataBuf, CARD_DATA_OFF_EC_SECOND_APP_COIN_CODE,
				(short) 0x02) == 0x00)
				&& isCPPSupportECCheck) {
			bIsECSecond = true;
			bIsTradeCoinMatch = true;
		...
		curTradeConditions[CURRENT_TRADE_CONDITION_OFF_SECOND_COIN_TRADE] = bIsECSecond;
		byte tradeResult = qPBOCCardRiskManager(apduBuf, bIsTradeCoinMatch,
				bIsECSecond);
		...
		if (TRADE_RESULT_TC == tradeResult) {
			...
			if (bIsTradeCoinMatch) {
				...
				if (extAppType == EXTEND_APP_TRADE_TYPE_SP) {
					...
					if (PBOCUtil.arrayCompare(abyCurTradeCardData,
							sECBalanceOff, pdolValue, sQPDOLTradeAuthMoneyOff,
							(short) 0x06) == -1) {
						// if EC Balance is not 0
						// remain = trade auth money - EC Balance
						PBOCUtil.arrayDecSub(pdolValue,
								sQPDOLTradeAuthMoneyOff, abyCurTradeCardData,
								sECBalanceOff, abyCurTradeCardData,
								sECBalanceOff);

						// DF63 += remain
						PBOCUtil.arrayDecAdd(abyCurTradeCardData,
								CARD_DATA_OFF_SP_DEDUCTION_MONEY,
								abyCurTradeCardData, sECBalanceOff,
								abyCurTradeCardData,
								CARD_DATA_OFF_SP_DEDUCTION_MONEY);
						Util.arrayFillNonAtomic(abyCurTradeCardData,
								sECBalanceOff, (short) 0x06, (byte) 0x00);
					} else {
						PBOCUtil.arrayDecSub(abyCurTradeCardData,
								sECBalanceOff, pdolValue,
								sQPDOLTradeAuthMoneyOff, abyCurTradeCardData,
								sECBalanceOff);
					}
				} else if (extAppType == EXTEND_APP_TRADE_TYPE_OPC) {
					...
					if (PBOCUtil
							.arrayCompare(pdolValue, sQPDOLTradeAuthMoneyOff,
									abyPBOCTradeSession,
									TRADE_SESSION_DATA_OFF_PRE_AUTH_MONEY,
									(short) 0x06) == 0x01) {
						PBOCUtil.arrayDecAdd(abyCurTradeCardData,
								sECBalanceOff, abyPBOCTradeSession,
								TRADE_SESSION_DATA_OFF_PRE_AUTH_MONEY,
								abyCurTradeCardData, sECBalanceOff);
						PBOCUtil.arrayDecAdd(abyCurTradeCardData,
								CARD_DATA_OFF_AVAILABLE_OFFLINE_MONEY,
						...
						// 6.2.7 脱机预授权完成交易时，如果脱机预授权完成金额小于脱机预授权金额，且分段扣费已抵扣金额（
						// DF63 ）大于零，
						// 脱机预授权剩余金额 = 脱机预授权金额 - 脱机预授权完成金额；
						// 如果脱机预授权剩余金额大于分段扣费已抵扣金额 （ DF63 ），则将分段扣费已抵扣金额 （ DF63
						// ）清零，
						// 同时设置当前电子现金余额（ 9F79 ） = 脱机预授权剩余金额 - 分段扣费已抵扣金额（ DF63 ）；
						// 如果脱机预授权剩余金额小于等于分段扣费已抵扣金额 （ DF63 ），则设置当前分段扣费已抵扣金额（
						// DF63 ） = 交易前分段扣费已抵扣金额（ DF63 ） - 脱机预授权剩余金额 。
						if (PBOCUtil.isAllZero(abyCurTradeCardData,
								CARD_DATA_OFF_SP_DEDUCTION_MONEY, (short) 0x06)) {
							PBOCUtil.arrayDecAdd(abyCurTradeCardData,
									sECBalanceOff, abyPBOCTradeSession,
									TRADE_SESSION_DATA_OFF_PRE_AUTH_MONEY,
							...
							PBOCUtil.arrayDecSub(abyCurTradeCardData,
									sECBalanceOff, pdolValue,
									sQPDOLTradeAuthMoneyOff,
									abyCurTradeCardData, sECBalanceOff);
						} else {
							// 脱机预授权金额 - 脱机预授权完成金额
							PBOCUtil.arrayDecSub(abyPBOCTradeSession,
									TRADE_SESSION_DATA_OFF_PRE_AUTH_MONEY,
									pdolValue, sQPDOLTradeAuthMoneyOff,
									abyCurTradeCardData, sECBalanceOff);
							// 如果脱机预授权剩余金额小于等于分段扣费已抵扣金额 （ DF63 ），则设置当前分段扣费已抵扣金额（
							// DF63 ） = 交易前分段扣费已抵扣金额（ DF63 ） - 脱机预授权剩余金额 。
							if (PBOCUtil.arrayCompare(abyCurTradeCardData,
								...
								PBOCUtil.arrayDecSub(abyCurTradeCardData,
										...
										CARD_DATA_OFF_SP_DEDUCTION_MONEY);
								Util.arrayFillNonAtomic(abyCurTradeCardData,
										sECBalanceOff, (short) 0x06,
										(byte) 0x00);
							} else {
								// 如果脱机预授权剩余金额大于分段扣费已抵扣金额 （ DF63 ）
								// 当前电子现金余额（ 9F79 ） = 脱机预授权剩余金额 - 分段扣费已抵扣金额（
								// DF63 ）
								PBOCUtil.arrayDecSub(abyCurTradeCardData,
										sECBalanceOff, abyCurTradeCardData,
										CARD_DATA_OFF_SP_DEDUCTION_MONEY,
					...
					case QPBOC_OFFLINE_CHECK_TYPE_EC_AND_CTTA_CHECK:
						...
						PBOCUtil.arrayDecSub(abyCurTradeCardData,
								CARD_DATA_OFF_EC_BALANCE, pdolValue,
								sQPDOLTradeAuthMoneyOff, abyCurTradeCardData,
								CARD_DATA_OFF_EC_BALANCE);
						PBOCUtil.arrayDecAdd(abyCurTradeCardData,
								CARD_DATA_OFF_TOTAL_OFFILINE_MONEY, pdolValue,
								sQPDOLTradeAuthMoneyOff, abyCurTradeCardData,
								CARD_DATA_OFF_TOTAL_OFFILINE_MONEY);
						break;
					case QPBOC_OFFLINE_CHECK_TYPE_EC_OR_CTTA_CHECK:
						// 脱机货币检查为小额或CTTA检查时
						// 1. 电子现金资金可用,
						// 如果授权金额（标签“9F02”）不大于电子现金余额（标签“9F79”），那么保存电子现金余额值并计算新的电子现金余额=电子现金余额－授权金额（标签“9F02”）
						// 2. 电子现金资金不可用从而用 CTTA 资金,
				...
				PBOCUtil.arrayDecSub(abyCurTradeCardData,
						CARD_DATA_OFF_AVAILABLE_OFFLINE_MONEY, pdolValue,
						sQPDOLTradeAuthMoneyOff, abyCurTradeCardData,
						CARD_DATA_OFF_AVAILABLE_OFFLINE_MONEY);
			}
			...
			if (qpbocTCGPORsp[(short) (sQPBOCTCRspIssueAppOff + 0x02)] == AC_VERSION_01) {
				// 终端参与应用密文计算的数据
				// 6 byte, 授权金额
				Util.arrayCopyNonAtomic(pdolValue, sQPDOLTradeAuthMoneyOff,
						apduBuf, (short) 0x00, (short) 0x06);
				// 6 byte, 其他金额
				Util.arrayCopyNonAtomic(pdolValue, sQPDOLTradeOtherMoneyOff,
						apduBuf, (short) 0x06, (short) 0x06);
				// 2 byte, 终端国家代码
				Util.arrayCopyNonAtomic(pdolValue, sQPDOLTerminalStateCodeOff,
						apduBuf, (short) 12, (short) 0x02);
				// 5 byte, 终端验证结果
				Util.arrayCopyNonAtomic(pdolValue, sQPDOLTerminalResultOff,
						apduBuf, (short) 14, (short) 0x05);
				// 2 byte, 交易货币代码
				Util.arrayCopyNonAtomic(pdolValue, sQPDOLTradeCoinCodeOff,
						apduBuf, (short) 19, (short) 0x02);
				// 3 byte, 交易日期
				Util.arrayCopyNonAtomic(pdolValue, sQPDOLTradeDateOff, apduBuf,
						(short) 21, (short) 0x03);
				// 1 byte, 交易类型
				apduBuf[(short) 24] = pdolValue[sQPDOLTradeTypeOff];
				// 4 byte, 不可预知数
				Util.arrayCopyNonAtomic(pdolValue,
						sQPDOLTerminalTradeRandomOff, apduBuf, (short) 25,
						(short) 0x04);

				// 卡片参与应用密文计算的数据
				// 2 byte, AIP
				Util.arrayCopyNonAtomic(paramBuf, PBOC_PARAM_OFF_QPBOC_AIP,
						apduBuf, (short) 29, (short) 0x02);
				// 2 byte, ATC
				Util.arrayCopyNonAtomic(cardDataBuf, CARD_DATA_OFF_ATC,
						apduBuf, (short) 31, (short) 0x02);
				// 4 byte, LV CVR
				apduBuf[33] = 0x03;
				Util.arrayCopyNonAtomic(abyPBOCTradeSession,
						TRADE_SESSION_DATA_OFF_CVR, apduBuf, (short) 34,
						(short) 0x03);

				signMac.sign(apduBuf, (short) 0x00, (short) 37,
						abyPBOCTradeSession, TRADE_SESSION_DATA_OFF_AC);
			} else {
				// 密文版本号17
				...
				// 4 byte, 不可预知数
				Util.arrayCopyNonAtomic(pdolValue,
						sQPDOLTerminalTradeRandomOff, apduBuf, (short) 0x06,
						(short) 0x04);

				// 卡片参与应用密文计算的数据
				// 2 byte, ATC
				Util.arrayCopyNonAtomic(cardDataBuf, CARD_DATA_OFF_ATC,
						apduBuf, (short) 10, (short) 0x02);
				// 发卡行应用数据第五个字节
				apduBuf[12] = abyPBOCTradeSession[TRADE_SESSION_DATA_OFF_CVR];

				signMac.sign(apduBuf, (short) 0x00, (short) 13,
						abyPBOCTradeSession, TRADE_SESSION_DATA_OFF_AC);
			}

			sLen = (short) qpbocTCGPORsp.length;
			// get gpo tc response template
			Util.arrayCopyNonAtomic(qpbocTCGPORsp, (short) 0x00, apduBuf,
					(short) 0x00, sLen);

			// update ATC
			Util.arrayCopyNonAtomic(cardDataBuf, CARD_DATA_OFF_ATC, apduBuf,
					sQPBOCTCRspATCOff, (short) 0x02);

			// 生成发卡行自定义数据
			generateIssueAppData(apduBuf, sQPBOCTCRspIssueAppOff,
					apduBuf[(short) (sQPBOCTCRspIssueAppOff - 0x01)]);
			// copy ac
			Util.arrayCopyNonAtomic(abyPBOCTradeSession,
					TRADE_SESSION_DATA_OFF_AC, apduBuf, sQPBOCTCRspACOff,
					(short) 0x08);

			if (bIsQPBOCSupportDDA) {
				short sDDALen = (short) ddaTemplate.length;
				if (sDDALen <= 0x80) {
					Util.arrayCopyNonAtomic(ddaTemplate, (short) 0x00, apduBuf,
							sQPBOCTCRspICCSIGOff, sDDALen);
					Util.arrayCopyNonAtomic(
							cardDataBuf,
							CARD_DATA_OFF_ATC,
							apduBuf,
							(short) (sQPBOCTCRspICCSIGOff + DDA_OFF_IC_DATA_DIGIT),
							(short) 0x02);

					msgDigest
							.update(apduBuf,
									(short) (sQPBOCTCRspICCSIGOff + DDA_OFF_SIGN_FORMAT),
									(short) (sDDALen - 22));

					if (PBOCUtil.isBitSet(pdolValue,
							sQPDOLVTerminalTradeAttrOff,
							TER_TRADE_ATT_OFF_SUPPORT_FDDA_VERSION)
							&& bIsPBOC3) {
						...
						// 9F02 授权金额 6字节 终端
						// 5F2A 交易货币代码 2字节 终端
						// 9F69 卡片认证相关数据 可变 卡片 (12部分附录C
						// 注：在本版本规范中，卡片认证相关数据使用8个字节长度，并且被个人化到卡片中。)
						// 9F36 应用交易计数器（ATC） 2字节 卡片
						msgDigest.update(pdolValue,
								sQPDOLTerminalTradeRandomOff, (short) 0x04);
						msgDigest.update(pdolValue, sQPDOLTradeAuthMoneyOff,
								(short) 0x06);
						msgDigest.update(pdolValue, sQPDOLTradeCoinCodeOff,
								(short) 0x02);

						// update 卡片认证相关数据
						abyCurTradeCardData[CARD_DATA_OFF_CARD_AUTH_DATA] = 0x01;
						random.generateData(abyCurTradeCardData,
								(short) (CARD_DATA_OFF_CARD_AUTH_DATA + 0x01),
								(short) 0x04);
						Util.arrayCopyNonAtomic(abyCurTradeCardData,
								CARD_DATA_OFF_CARD_TRADE_ATTRIBUTE,
								abyCurTradeCardData,
								(short) (CARD_DATA_OFF_CARD_AUTH_DATA + 0x05),
								(short) 0x02);
						...
						msgDigest.doFinal(abyCurTradeCardData,
								CARD_DATA_OFF_CARD_AUTH_DATA, (short) 0x08,
								apduBuf, (short) (sQPBOCTCRspICCSIGOff
										+ sDDALen - 21));
					} else {
						...
						// 9F37 不可预知数 4字节 终端
						// 9F36 应用交易计数器（ATC） 2字节 卡片
						msgDigest.doFinal(pdolValue,
								sQPDOLTerminalTradeRandomOff, (short) 0x04,
								apduBuf, (short) (sQPBOCTCRspICCSIGOff
										+ sDDALen - 21));
					}

					cipherRSA.doFinal(apduBuf, sQPBOCTCRspICCSIGOff, sDDALen,
							apduBuf, sQPBOCTCRspICCSIGOff);
				}
			}

			// update card trade attribute
			Util.arrayCopyNonAtomic(abyCurTradeCardData,
					CARD_DATA_OFF_CARD_TRADE_ATTRIBUTE, apduBuf,
					sQPBOCTCRspCardAttrOff, (short) 0x02);

			// update 9F5D
			if (sQPBOCTCRspAvailMoneyOff != INVALID_VALUE) {
				Util.arrayCopyNonAtomic(abyCurTradeCardData,
						CARD_DATA_OFF_AVAILABLE_OFFLINE_MONEY, apduBuf,
						sQPBOCTCRspAvailMoneyOff, (short) 0x06);
			}

			if (extAppType == EXTEND_APP_TRADE_TYPE_OP) {
				short sTmp = (short) (sQPBOCTCRspACOff + 0x08);
				Util.arrayCopyNonAtomic(apduBuf, sTmp, apduBuf,
						(short) (sQPBOCTCRspACOff - 0x03),
						(short) (sLen - sTmp));
				sLen -= 11;
				...
				if (bFlag) {
					if (sTmp < 0x80) {
						...
						Util.arrayCopyNonAtomic(apduBuf, (short) 0x03, apduBuf,
								(short) 0x02, sTmp);
						sLen--;
					} else {
			...
			if (TRADE_RESULT_ARQC == tradeResult) {
				 ...
				 */
				if (isCPPFstContactPBOCOnline
						&& PBOCUtil.isBitSet(pdolValue,
								sQPDOLVTerminalTradeAttrOff,
								TER_TRADE_ATT_OFF_SUPPORT_CONTACT_PBOC)) {
					ISOException.throwIt(ISO7816.SW_CONDITIONS_NOT_SATISFIED);
				}
				...
				if (isCPPSupportPrePay) {
					// 授权金额为0
					if (PBOCUtil.isAllZero(pdolValue, sQPDOLTradeAuthMoneyOff,
							(short) 0x06)) {
						...
						if (isCPPSupportECAndCTTACheck) {
							...
							if ((PBOCUtil.arrayCompare(pdolValue,
									...
									CARD_DATA_OFF_EC_BALANCE, (short) 0x06) == 1)
									|| (PBOCUtil.arrayCompare(pdolValue,
											sQPDOLTradeAuthMoneyOff, apduBuf,
											(short) 0x00, (short) 0x06) == 1)) {
								tradeResult = CVR_1ST_GEN_AC_RETURN_AAC;
							} else {
								// 预付且资金可用
								...
								PBOCUtil.arrayDecSub(apduBuf, (short) 0x00,
										pdolValue, sQPDOLTradeAuthMoneyOff,
										apduBuf, (short) 0x00);
								Util.arrayCopyNonAtomic(apduBuf, (short) 0x00,
										abyCurTradeCardData,
										CARD_DATA_OFF_AVAILABLE_OFFLINE_MONEY,
										(short) 0x06);
			...
			// Util.arrayCopyNonAtomic(abyCurTradeCardData, CARD_DATA_OFF_ATC,
			// abyCurTradeCardData, CARD_DATA_OFF_PREONLINE_ATC, (short)0x02);
			// }
			...
			if (qpbocARQCACCGPORsp[(short) (sQPBOCARQCAACRspIssueAPPOff + 0x02)] == AC_VERSION_01) {
				// 终端参与应用密文计算的数据
				// 6 byte, 授权金额
				sLen = Util.arrayCopyNonAtomic(pdolValue,
						sQPDOLTradeAuthMoneyOff, apduBuf, (short) 0x00,
						(short) 0x06);
				// 6 byte, 其他金额
				sLen = Util.arrayCopyNonAtomic(pdolValue,
						sQPDOLTradeOtherMoneyOff, apduBuf, sLen, (short) 0x06);
				// 2 byte, 终端国家代码
				sLen = Util
						.arrayCopyNonAtomic(pdolValue,
								sQPDOLTerminalStateCodeOff, apduBuf, sLen,
								(short) 0x02);
				// 5 byte, 终端验证结果
				sLen = Util.arrayCopyNonAtomic(pdolValue,
						sQPDOLTerminalResultOff, apduBuf, sLen, (short) 0x05);
				// 2 byte, 交易货币代码
				sLen = Util.arrayCopyNonAtomic(pdolValue,
						sQPDOLTradeCoinCodeOff, apduBuf, sLen, (short) 0x02);
				// 3 byte, 交易日期
				sLen = Util.arrayCopyNonAtomic(pdolValue, sQPDOLTradeDateOff,
						apduBuf, sLen, (short) 0x03);
				// 1 byte, 交易类型
				apduBuf[sLen++] = pdolValue[sQPDOLTradeTypeOff];
				// 4 byte, 不可预知数
				sLen = Util.arrayCopyNonAtomic(pdolValue,
						sQPDOLTerminalTradeRandomOff, apduBuf, sLen,
						(short) 0x04);

				// 卡片参与应用密文计算的数据
				// 2 byte, AIP
				sLen = Util.arrayCopyNonAtomic(paramBuf,
						PBOC_PARAM_OFF_QPBOC_AIP, apduBuf, sLen, (short) 0x02);
				// 2 byte, ATC
				sLen = Util.arrayCopyNonAtomic(cardDataBuf, CARD_DATA_OFF_ATC,
						apduBuf, sLen, (short) 0x02);
				// 4 byte, LV CVR
				apduBuf[sLen++] = 0x03;
				sLen = Util
						.arrayCopyNonAtomic(abyPBOCTradeSession,
								TRADE_SESSION_DATA_OFF_CVR, apduBuf, sLen,
								(short) 0x03);
			} else {
				// 密文版本号17
			...
			signMac.sign(apduBuf, (short) 0x00, sLen, abyPBOCTradeSession,
					TRADE_SESSION_DATA_OFF_AC);

			sLen = (short) qpbocARQCACCGPORsp.length;
			// get gpo arqc/aac response template
			Util.arrayCopyNonAtomic(qpbocARQCACCGPORsp, (short) 0x00, apduBuf,
					(short) 0x00, sLen);

			// update ATC
			Util.arrayCopyNonAtomic(cardDataBuf, CARD_DATA_OFF_ATC, apduBuf,
					sQPBOCARQCAACRspATCOff, (short) 0x02);

			// 生成发卡行自定义数据
			generateIssueAppData(apduBuf, sQPBOCARQCAACRspIssueAPPOff,
					apduBuf[(short) (sQPBOCARQCAACRspIssueAPPOff - 0x01)]);

			Util.arrayCopyNonAtomic(abyPBOCTradeSession,
					TRADE_SESSION_DATA_OFF_AC, apduBuf, sQPBOCARQCAACRspACOff,
					(short) 0x08);

			// update card trade attribute
			Util.arrayCopyNonAtomic(abyCurTradeCardData,
					CARD_DATA_OFF_CARD_TRADE_ATTRIBUTE, apduBuf,
					sQPBOCARQCAACRspCardAttrOff, (short) 0x02);

			// update 9F5D
			if (sQPBOCARQCAACRspAvailMoneyOff != INVALID_VALUE) {
				Util.arrayCopyNonAtomic(abyCurTradeCardData,
						CARD_DATA_OFF_AVAILABLE_OFFLINE_MONEY, apduBuf,
						sQPBOCARQCAACRspAvailMoneyOff, (short) 0x06);
			}

			Util.arrayCopy(
					abyCurTradeCardData,
					CARD_DATA_OFF_EXT_APP_LASTTRADE_INFO,
					cardDataBuf,
					CARD_DATA_OFF_EXT_APP_LASTTRADE_INFO,
					(short) (CARD_DATA_OFF_DCOINTOTAL_OFFILINE_MONEY - CARD_DATA_OFF_EXT_APP_LASTTRADE_INFO));
		}
	...
	private short PBOCGPOProcess(byte[] apduBuf) {
		...
		// set aip
		Util.arrayCopyNonAtomic(gpo, (short) 0x00, abyPBOCTradeSession,
				TRADE_SESSION_DATA_OFF_AIP, (short) 0x02);

		return PBOCUtil.appendTLV((short) 0x80, gpo, (short) 0x00,
				(short) gpo.length, apduBuf, (short) 0x00);
	}
	...
	private void onGPO(APDU apdu) {
		...
		if (sATC == (short) 0xFFFF) {
			...
			Util.arrayFillNonAtomic(abyPBOCTradeSession, (short) 0x00,
					(short) abyPBOCTradeSession.length, (byte) 0x00);
		...
		// copy PDOL Value
		Util.arrayCopyNonAtomic(apduBuf, sOff, pdolValue, (short) 0x00,
				sPDOLValueLen);
		...
		if (abyPBOCTradeSession[TRADE_SESSION_DATA_OFF_TRADE_INTERFACE] == TRADE_INTERFACE_CONTACT) {
			...
			if (PBOCUtil.isBitSet(pdolValue, sQPDOLVTerminalTradeAttrOff,
					TER_TRADE_ATT_OFF_SUPPORT_CONTACTLESS_PBOC)) {
				tradeType = TRADE_TYPE_PBOC;
				...
				sLen = PBOCGPOProcess(apduBuf);
					...
					sQPDOLVTerminalTradeAttrOff,
					TER_TRADE_ATT_OFF_SUPPORT_QPBOC)) {
	...
	private short readTradeLog(byte sfi, byte[] logFile, short recNo, byte[] buf) {
		...
		if (logFile == null || (logFile[LOG_INFO_OFF_SFI] != sfi)
				|| (recNo == 0x00)
		...
		while (sOffset < fileSize) {
			if (PBOCUtil.arrayCompare(logFile, sOffset, logFile, sDstOffset,
					(short) 0x04) == 1) {
				sDstOffset = sOffset;
			}
		...
		if (PBOCUtil.isAllZero(logFile, sDstOffset, (short) 0x04)
				|| (PBOCUtil.arrayCompare(buf, (short) 0x00, logFile,
						sDstOffset, (short) 0x04) == 0x01)) {
			return 0x00;
		}
	...
	private short readChargeLog(byte sfi, short recNo, byte[] buf) {
		...
		short sDstOffset = LOG_INFO_OFF_CONTENT;
		while (sOffset < fileSize) {
			if (PBOCUtil.arrayCompare(chargeLogFile, sOffset, chargeLogFile,
					sDstOffset, (short) 0x04) == 1) {
				sDstOffset = sOffset;
			}
		...
		if (recNo == 0x00) {
			...
			// 日志完整性验证码 4 byte
			byte recCntr = 0x00;
			Util.arrayCopyNonAtomic(cardDataBuf, CARD_DATA_OFF_ATC, buf,
					(short) 0x00, (short) 0x02);

			short logFromatLen = (short) chargelogFormat.length;
			short sDateOff = PBOCUtil.findValuePosInTLList(TAG_TRADE_DATE,
					chargelogFormat, (short) 0x00, logFromatLen);
			short sTimeOff = PBOCUtil.findValuePosInTLList(TAG_TRADE_TIME,
					chargelogFormat, (short) 0x00, logFromatLen);
			short sATCOff = PBOCUtil.findValuePosInTLList(TAG_ATC,
					chargelogFormat, (short) 0x00, logFromatLen);

			// 最多返回最近10*22个字节的日志数据内容
			short sRecNum = (short) (chargeLogFile[LOG_INFO_OFF_RECNUM] & 0x0FF);
			sLen = 0x03;
			Util.arrayFillNonAtomic(sessionKey, (short) 0x00, (short) 0x04,
					(byte) 0x00);
			for (short i = 0x00; (i < sRecNum) && (recCntr < 10); i++) {
				Util.setShort(sessionKey, (short) 0x02, i);
				if (PBOCUtil.arrayCompare(sessionKey, (short) 0x00,
						chargeLogFile, sDstOffset, (short) 0x04) >= 0x00) {
					break;
				}

				short sTmp = (short) (i * sRecLen);
				if ((short) (sTmp + LOG_INFO_OFF_CONTENT) > sDstOffset) {
					sTmp = (short) (fileSize - LOG_INFO_OFF_CONTENT
							+ sDstOffset - sTmp);
				} else {
				...
				// 交易时间 3 byte
				// 应用交易计数器（ATC） 2 byte
				sLen = Util.arrayCopyNonAtomic(chargeLogFile,
						(short) (sTmp + 0x04), buf, sLen, (short) 14);
				sLen = Util.arrayCopyNonAtomic(chargeLogFile,
						(short) (sTmp + 0x04 + 14 + sDateOff), buf, sLen,
						(short) 3);
				sLen = Util.arrayCopyNonAtomic(chargeLogFile,
						(short) (sTmp + 0x04 + 14 + sTimeOff), buf, sLen,
						(short) 3);
				sLen = Util.arrayCopyNonAtomic(chargeLogFile,
						(short) (sTmp + 0x04 + 14 + sATCOff), buf, sLen,
						(short) 2);
			...
			// 1. log file is empty
			// 2. read record number > valid record number
			Util.arrayFillNonAtomic(buf, (short) 0x00, (short) 0x04,
					(byte) 0x00);
			Util.setShort(buf, (short) 0x02, recNo);
			if (PBOCUtil.isAllZero(chargeLogFile, sDstOffset, (short) 0x04)
					|| (PBOCUtil.arrayCompare(buf, (short) 0x00, chargeLogFile,
							sDstOffset, (short) 0x04) == 0x01)) {
				return 0x00;
			}
			...
			Util.arrayCopyNonAtomic(chargeLogFile, sDstOffset, buf,
					(short) 0x00, sLen);
		}
	...
	private void onReadRecord(APDU apdu) {
		...
		if (sTmp != dgi) {
			...
			short sLen = readTradeLog(sfi, tradeLogFile,
					(short) (recNo & 0x0FF), apduBuf);
			...
			if (sLen == 0x00) {
				sLen = readTradeLog(sfi, extendlogFile,
						(short) (recNo & 0x0FF), apduBuf);
				// if (sLen != 0x00) {
				// abyPBOCTradeSession[TRADE_SESSION_DATA_OFF_EXT_APP_CUR_SFI] =
				// sfi;
				// Util.arrayFillNonAtomic(abyPBOCTradeSession,
				// TRADE_SESSION_DATA_OFF_EXT_APP_CUR_ID, (short)0x02,
				// (byte)0x00);
				// }
			}
		...
		Util.arrayCopyNonAtomic(record, (short) 0x00, apduBuf, (short) 0x00,
				sLen);
		sLen = apduBuf[0x01];
		if (sLen == (byte) 0x81) {
		...
		if (abyPBOCTradeSession[TRADE_SESSION_DATA_OFF_TRADE_TYPE] == TRADE_TYPE_QPBOC) {
			if (dgi == sQPBOCSigDGI) {
				...
				short sDDALen = (short) ddaTemplate.length;
				Util.arrayCopyNonAtomic(ddaTemplate, (short) 0x00, apduBuf,
						sQPBOCSigOff, sDDALen);
				Util.arrayCopyNonAtomic(cardDataBuf, CARD_DATA_OFF_ATC,
						apduBuf,
						(short) (sQPBOCSigOff + DDA_OFF_IC_DATA_DIGIT),
						(short) 0x02);

				msgDigest.update(apduBuf,
						(short) (sQPBOCSigOff + DDA_OFF_SIGN_FORMAT),
						(short) (sDDALen - 22));

				if (PBOCUtil.isBitSet(pdolValue, sQPDOLVTerminalTradeAttrOff,
						TER_TRADE_ATT_OFF_SUPPORT_FDDA_VERSION) && bIsPBOC3) {
					// fDDA version 00 用于输入DDA哈希算法的终端动态数据
					// 标签 数据元素 长度 数据来源
					// 9F37 不可预知数 4字节 终端
					// 9F02 授权金额 6字节 终端
					...
					// 注：在本版本规范中，卡片认证相关数据使用8个字节长度，并且被个人化到卡片中。)
					// 9F36 应用交易计数器（ATC） 2字节 卡片
					msgDigest.update(pdolValue, sQPDOLTerminalTradeRandomOff,
							(short) 0x04);
					msgDigest.update(pdolValue, sQPDOLTradeAuthMoneyOff,
							(short) 0x06);
					msgDigest.update(pdolValue, sQPDOLTradeCoinCodeOff,
					...
					msgDigest.doFinal(abyCurTradeCardData,
							CARD_DATA_OFF_CARD_AUTH_DATA, (short) 0x08,
							apduBuf, (short) (sQPBOCSigOff + sDDALen - 21));
				} else {
					abyCurTradeCardData[CARD_DATA_OFF_CARD_AUTH_DATA] = 0x00;
					// fDDA version 00 用于输入DDA哈希算法的终端动态数据
					// 标签 数据元素 长度 数据来源
					// 9F37 不可预知数 4字节 终端
					// 9F36 应用交易计数器（ATC） 2字节 卡片
					msgDigest.doFinal(pdolValue, sQPDOLTerminalTradeRandomOff,
							(short) 0x04, apduBuf, (short) (sQPBOCSigOff
									+ sDDALen - 21));
				}

				cipherRSA.doFinal(apduBuf, sQPBOCSigOff, sDDALen, apduBuf,
						sQPBOCSigOff);
			}
			...
			if (dgi == sQPBOC9F5DDGI) {
				...
				Util.arrayCopyNonAtomic(abyCurTradeCardData,
						CARD_DATA_OFF_AVAILABLE_OFFLINE_MONEY, apduBuf,
						sQPBOC9F5DOff, (short) 0x06);
				Util.arrayCopy(abyCurTradeCardData,
						CARD_DATA_OFF_AVAILABLE_OFFLINE_MONEY, cardDataBuf,
						CARD_DATA_OFF_AVAILABLE_OFFLINE_MONEY, (short) 0x06);
			}
			...
			if (dgi == sQPBOCLastRecDGI) {
				...
				if (isCPPQPBOCSupportTradeLog) {
					...
					Util.arrayCopyNonAtomic(record, (short) 0x00, apduBuf,
							(short) 0x00, sLen);
				}
				...
				if (abyCurTradeCardData[CARD_DATA_OFF_CARD_AUTH_DATA] == 0x01) {
					...
					sLen = PBOCUtil.appendTLV(TAG_CARD_AUTH_DATA,
							abyCurTradeCardData, CARD_DATA_OFF_CARD_AUTH_DATA,
							(short) 0x08, apduBuf, sLen);
					if (apduBuf[0x01] == (byte) 0x81) {
						...
						apduBuf[0x01] = (byte) sTmp;
						if (sTmp > 0x7F) {
							sLen = Util.arrayCopyNonAtomic(apduBuf,
									(short) 0x02, apduBuf, (short) 0x03, sTmp);
				...
				if (extTradeType != EXTEND_APP_TRADE_TYPE_NOT_SUPPORT) {
					...
					Util.arrayFillNonAtomic(abyCurTradeCardData,
							CARD_DATA_OFF_EXT_APP_LASTTRADE_INFO, (short) 0x0A,
							(byte) 0x00);
					Util.arrayCopyNonAtomic(cardDataBuf, CARD_DATA_OFF_ATC,
							abyCurTradeCardData,
							CARD_DATA_OFF_EXT_APP_LASTTRADE_INFO, (short) 0x02);
					...
					if (extTradeType != EXTEND_APP_TRADE_TYPE_OP) {
						Util.arrayCopyNonAtomic(
								...
								TRADE_SESSION_DATA_OFF_AC,
								abyCurTradeCardData,
								(short) (CARD_DATA_OFF_EXT_APP_LASTTRADE_INFO + 0x02),
								(short) 0x08);
					}
					...
					if (extTradeType == EXTEND_APP_TRADE_TYPE_OP) {
						// 设置预付费交易预授权金额
						short extPreAuthOff = Util.getShort(
								abyPBOCTradeSession,
								TRADE_SESSION_DATA_OFF_EXT_CUR_CONTEXT_OFF);
						...
						Util.arrayCopyNonAtomic(
								abyPBOCTradeSession,
								TRADE_SESSION_DATA_OFF_EXT_APP_CUR_ID,
								extendPreAuthContext,
								(short) (extPreAuthOff + EXT_PREAUTH_CONTEXT_OFF_ID),
								(short) 0x02);
						Util.arrayCopyNonAtomic(
								pdolValue,
								sQPDOLTradeAuthMoneyOff,
								extendPreAuthContext,
								(short) (extPreAuthOff + EXT_PREAUTH_CONTEXT_OFF_MONEY),
								(short) 0x06);
					} else if (extTradeType == EXTEND_APP_TRADE_TYPE_OPC) {
						Util.arrayFillNonAtomic(
								extendPreAuthContext,
								Util.getShort(abyPBOCTradeSession,
										TRADE_SESSION_DATA_OFF_EXT_CUR_CONTEXT_OFF),
								EXT_PREAUTH_CONTEXT_ITEM_LEN, (byte) 0x00);
					}
				}
				...
				// backup last record
				Util.arrayCopy(apduBuf, (short) 0x00, apduBuf, (short) 0x02,
						sLen);
				Util.setShort(apduBuf, (short) 0x00, sLen);
				Util.arrayCopy(apduBuf, (short) 0x00, backRecord, (short) 0x00,
						(short) (sLen + 0x02));
				Util.arrayCopy(apduBuf, (short) 0x02, apduBuf, (short) 0x00,
						sLen);
		...
		if (abyPBOCTradeSession[TRADE_SESSION_DATA_OFF_STATE] == TRADE_STATE_APP_SELECT) {
			...
			// process 9F5D
			sTmp = PBOCUtil.findValueOffByTag(TAG_AVAILABLE_OFFLINE_MONEY,
					apduBuf, sOff, sValueLen);
			if (sTmp != PBOCUtil.TAG_NOT_FOUND) {
				calAvailableMoney();

				sTmp += (short) (sOff + 0x03);
				if (Util.arrayCompare(apduBuf, sTmp, abyCurTradeCardData,
						CARD_DATA_OFF_AVAILABLE_OFFLINE_MONEY, (short) 0x06) != 0x00) {
					Util.arrayCopyNonAtomic(apduBuf, sTmp, abyCurTradeCardData,
							CARD_DATA_OFF_AVAILABLE_OFFLINE_MONEY, (short) 0x06);
				}
			}

			// find 9F4B
			sTmp = PBOCUtil.findValueOffByTag(TAG_SIGN_DYNAMIC_APP_DATA,
					apduBuf, sOff, sValueLen);
			if (sTmp != PBOCUtil.TAG_NOT_FOUND) {
				sTmp += (short) (sOff + 0x02);
				sValueLen = (short) (apduBuf[(short) (sTmp + 0x01)] & 0x0FF);
				if (PBOCUtil.isAllZero(apduBuf, (short) (sTmp + 0x02),
						sValueLen)) {
					apduBuf[sTmp] = 0x00;
					...
					if (remainLen > 0x00) {
						Util.arrayCopyNonAtomic(apduBuf,
								(short) (sTmp + 0x02 + sValueLen), apduBuf,
								(short) (sTmp + 0x01), remainLen);
					}
		...
		if ((dgi == sQPBOCLastRecDGI) && bBack && (sTmp != 0x00)) {
			sLen = sTmp;
			Util.arrayCopy(backRecord, (short) 0x02, apduBuf, (short) 0x00,
					sLen);
		}
	...
	private void onGetData(APDU apdu) {
		...
		case TAG_PIN_RETRY_CNTR:
			sLen = PBOCUtil.appendTLV(sTag, paramBuf,
					PBOC_PARAM_OFF_PIN_LEFT_CNTR, (short) 0x01, apduBuf,
					(short) 0x00);
			break;
		case TAG_AVAILABLE_OFFLINE_MONEY:
			...
			// if (isCPPReturnAvailableMoney) {
			calAvailableMoney();
			sLen = PBOCUtil.appendTLV(sTag, abyCurTradeCardData,
					getDataTags[index], (short) 0x06, apduBuf, (short) 0x00);
			// } else {
			// ISOException.throwIt(SW_REFERENCED_DATA_NOT_FOUND);
			// }
			break;
		case TAG_LOG_FORMAT:
			if (logFormat == null) {
				...
				sLen = PBOCUtil.appendTLV(sTag, logFormat, (short) 0x00,
						(short) logFormat.length, apduBuf, (short) 0x00);
			}
			break;
		case TAG_CHARGE_LOG_FORMAT:
			if (chargelogFormat == null) {
				...
				sLen = PBOCUtil.appendTLV(sTag, chargelogFormat, (short) 0x00,
						(short) chargelogFormat.length, apduBuf, (short) 0x00);
			}
			break;
		case TAG_CAPP_SECTION_PURCHASE_APP_ID:
			...
			sLen = PBOCUtil.appendTLV(sTag, abyPBOCTradeSession,
					TRADE_SESSION_DATA_OFF_EXT_APP_INDICATE, (short) 0x01,
					apduBuf, (short) 0x00);
			break;
		case TAG_GET_APP_VERSION:
			sLen = PBOCUtil.appendTLV(sTag, app_version, (short) 0x00,
					(short) app_version.length, apduBuf, (short) 0x00);
			break;
		case TAG_GET_APP_NAME:
			sLen = PBOCUtil.appendTLV(sTag, app_name, (short) 0x00,
					(short) app_name.length, apduBuf, (short) 0x00);
			break;
		default:
			...
			if (curTradeConditions[CURRENT_TRADE_CONDITION_OFF_SECOND_COIN_TRADE]) {
				switch (sTag) {
				// 当终端以 GET DATA
				// 命令读取电子现金余额（标签“9F79”）时，卡片应将第二币种电子现金余额（标签“DF79”）的值返回
				case TAG_EC_BALANCE:
					sOff = CARD_DATA_OFF_EC_SECOND_BALANCE;
					break;
				// 当终端以 GET DATA
				// 命令读取电子现金重置阈值（标签“9F6D”）时，卡片应将第二币种电子现金重置阈值（标签“DF76”）的值返回
				case TAG_EC_RESET_THRESHOLD:
					sOff = CARD_DATA_OFF_EC_SECOND_RESET_THRESHOLD;
					break;
				// 当终端以 GET DATA
				// 命令读取电子现金余额上限（标签“9F77”）时，卡片应将第二币种电子现金余额上限（标签“DF77”）的值返回
				case TAG_EC_BALANCE_LIMIT:
					sOff = CARD_DATA_OFF_EC_SECOND_BALANCE_LIMIE;
					break;
				// 当终端以 GET DATA
				// 命令读取电子现金单笔交易限额（标签“9F78”）时，卡片应将第二币种电子现金单笔交易限额（标签“DF78”）的值返回
				case TAG_SINGLE_TRADE_LIMIT:
					sOff = CARD_DATA_OFF_EC_SECOND_SINGLE_TRADE_LIMIT;
					break;
				// 当终端以 GET DATA 命令读取卡片 CVM 限额（标签“9F6B”）时，卡片应将第二币种卡片
				// CVM限额（标签“DF72”）的值返回
			...
			sLen = PBOCUtil.appendTLV(sTag, src, sOff, sValueLen, apduBuf,
					(short) 0x00);
		}
	 ...
	 * @param acType
	 *            AC type
	 * @param abyCurTradeCDOL
	 *            CDOL
	 * @param abyCurTradeCDOLValue
	 *            CDOL Value
	 * @param abyCurTradePDOL
	 *            PDOL
	 * @return true check success, false check failed
	 */
	private boolean ecGACCheck(byte acType, byte[] abyCurTradeCDOL,
			byte[] abyCurTradeCDOLValue, byte[] abyCurTradePDOL) {
		// 第13部分 7.4.5 卡片行为分析
		/*
		 ...
		 * 果为一致，则卡片从电子现金余额中扣除授权金额并在GENERATE AC命令响应中返回TC，否 则卡片在GENERATE
		 * AC命令响应中返回AAC；
		 */
		...
		while (i < sCDOLLen) {
			...
			if ((sTag == TAG_TVR) || (sTag == TAG_TRADE_STATE_INFO)
					|| ((sTag == TAG_TERMINAL_TRADE_RANDOM))) {
				continue;
			}

			short sPDOLOff = PBOCUtil.findValuePosInTLList(sTag,
					abyCurTradePDOL, (short) 0x00, sPDOLLen);
			if (sPDOLOff != PBOCUtil.TAG_NOT_FOUND) {
				short sCDOLOff = PBOCUtil.findValuePosInTLList(sTag,
						abyCurTradeCDOL, (short) 0x00, sCDOLLen);
				if ((sCDOLOff != PBOCUtil.TAG_NOT_FOUND)
						&& (Util.arrayCompare(pdolValue, sPDOLOff,
								abyCurTradeCDOLValue, sCDOLOff, sValueLen) != 0x00)) {
					return false;
				}
			}
		}
	 ...
	 * @return trade result
	 */
	private byte cardRiskManager_1(byte acType, byte[] abyCurTradePDOL,
			byte[] tmpBuf) {
		/**
		 * 3. 上次交易静态数据认证（SDA）失败检查 如果支持SDA，此检查必备执行。检查上次脱机拒绝的交易中SDA是否失败。
		 * 如果SDA失败指示位为“1”，卡片设置CVR中“上次交易SDA失败而且交易拒绝”位为“1”。
		 */
		if (PBOCUtil.isBitSet(abyPBOCTradeSession, TRADE_SESSION_DATA_OFF_AIP,
				AIP_SUPPORT_OFF_SDA)
				&& (abyCurTradeCardData[CARD_DATA_OFF_LAST_TRADE_REFUSE_SDA_FAILED] == 0x01)) {
			PBOCUtil.setBit(abyPBOCTradeSession, TRADE_SESSION_DATA_OFF_CVR,
					CVR_OFF_LAST_TRADE_REFUSE_SDA_FAILED);
		}

		/**
		 * 4. 上次交易动态数据认证（DDA）失败检查 如果支持DDA，此检查强制执行。检查上次脱机拒绝的交易中DDA是否失败。
		...
		if (PBOCUtil.isBitSet(abyPBOCTradeSession, TRADE_SESSION_DATA_OFF_AIP,
			...
			PBOCUtil.setBit(abyPBOCTradeSession, TRADE_SESSION_DATA_OFF_CVR,
					CVR_OFF_LAST_TRADE_REFUSE_DDA_FAILED);
		}

		/**
		 * 若是电子现金应用 跳过联机授权未完成检查、上次交易发卡行认证失败检查、上次联机交易发卡行脚本处理检查、 新卡检查、脱机 PIN
		 * 尝试次数检查及各类频度检查， 进行上次交易 SDA 失败检查和上次交易 DDA 失败检查；
		 */
		if (abyPBOCTradeSession[TRADE_SESSION_DATA_OFF_TRADE_TYPE] == TRADE_TYPE_EC) {
		...
		/**
		 * 1. 联机授权没有完成检查 如果支持发卡行认证或发卡行脚本命令，需要执行此检查
		 * 检查在上次交易中，在卡片请求一个联机授权之后，在终端接收到联机响应进行处理之前或无法联机的终端处理之前，卡片是否离开了终端设备
		 * 如果联机授权指示位设为“1”，卡片： 设置卡片请求联机指示位置“1” 设置 CVR 中“上次联机交易没完成”位为“1”
		 */
		if (abyCurTradeCardData[CARD_DATA_OFF_LAST_TRADE_ONLINE_AUTH] == 0x01) {
			tradeResult = TRADE_RESULT_ARQC;
			PBOCUtil.setBit(abyPBOCTradeSession, TRADE_SESSION_DATA_OFF_CVR,
					CVR_OFF_LAST_ONLINE_TRADE_UNFINISHED);
		}

		/**
		 * 2. 上次交易发卡行认证失败（或必备未执行）检查 如果卡片AIP中表明支持发卡行认证，则应执行此检查。
		 * 如果上次交易发卡行认证（1）失败或（2）必备（发卡行认证指示位表示）但是没有执行，卡片请求联机处理。
		 * 如果发卡行认证失败指示位设为“1”，卡片： 设置 CVR 中“上次联机交易发卡行认证失败”位为“1”；
		 * 如果应用缺省行为（ADA）中“发卡行认证失败，下次交易联机上送”位为“1”，设置卡片请求联机指示位置“1”。
		 */
		if (PBOCUtil.isBitSet(abyPBOCTradeSession, TRADE_SESSION_DATA_OFF_AIP,
				AIP_SUPPORT_OFF_ISSUE_AUTH)
				&& (abyCurTradeCardData[CARD_DATA_OFF_LAST_TRADE_ISSUE_AUTH_FAILED] == 0x01)) {
			PBOCUtil.setBit(abyPBOCTradeSession, TRADE_SESSION_DATA_OFF_CVR,
					CVR_OFF_LAST_ONLINE_TRADE_ISSUE_AUTH_FAILED);
			if (PBOCUtil.isBitSet(cardDataBuf, CARD_DATA_OFF_ADA,
					ADA_OFF_ISSUE_AUTH_FAILED)) {
				tradeResult = TRADE_RESULT_ARQC;
			}
		}
		...
		if (abyCurTradeCardData[CARD_DATA_OFF_LAST_TRADE_ISSUE_SCRIPT_RUN_FAILED] == 0x01) {
			PBOCUtil.setBit(abyPBOCTradeSession, TRADE_SESSION_DATA_OFF_CVR,
					CVR_OFF_LAST_TRADE_ISSUE_SCRIPT_FAILED);
			if (PBOCUtil.isBitSet(cardDataBuf, CARD_DATA_OFF_ADA,
					ADA_OFF_LAST_TRADE_ISSUE_SCRIPT_FAILED)) {
				tradeResult = TRADE_RESULT_ARQC;
			}
		}

		/**
		 * 6. 连续脱机交易下限频度检查 此检查可选。如果连续脱机交易次数超过此下限，卡片请求联机授权。 如果上次联机ATC寄存器和JR/T
		 * 0025专有数据：连续脱机交易下限（标签“9F58”）存在，卡片可以执行此检查。
		 * 如果ATC和上次联机ATC寄存器的差值大于连续脱机交易下限，卡片： 设置 CVR 中“频度检查超过”位为“1”
		...
		if (cardDataBuf[CARD_DATA_OFF_OFFLINE_CARD_LOWLIMIT] != (byte) 0xFF) {
			short sPreOnlineATC = Util.getShort(abyCurTradeCardData,
					CARD_DATA_OFF_PREONLINE_ATC);
			short sATC = Util.getShort(cardDataBuf, CARD_DATA_OFF_ATC);
		 ...
		 * 设置 CVR 中“频度检查超过”位为“1” 设置卡片请求联机指示位为“1”
		 */
		if (cardDataBuf[CARD_DATA_OFF_COIN_OFFLINE_CARD_LIMIT] != (byte) 0xFF) {
			if (Util.arrayCompare(cardDataBuf, CARD_DATA_OFF_APPCOINCODE,
					cdol1Value, tradeCoinCodeOff, (short) 0x02) != 0x00) {
		...
		/**
		 * 8. 连续国际脱机交易（基于国家）限制数频度检查 此检查可选。如果连续脱机交易计数器（国际-国家）超过连续脱机交易限制数（国际-国家），
		 * 卡片请求联机授权。 此检查定义的国际脱机交易是终端送进的终端国家代码和卡片中的发卡行国家代码不同的交易。
		 * 如果数据发卡行国家代码、连续脱机交易计数器（国际-国家）、连续脱机交易限制次数（国际-国家）存在，卡片执行此检查。 如果下面两个条件都满足
		 * 终端国家代码和发卡行国家代码不同 连续脱机交易计数器（国际-国家）加 1 的值大于连续脱机交易限制次数（国际-国家） 卡片: 设置 CVR
		 * 中“频度检查超过”位为“1” 设置卡片请求联机指示位为“1”
		 */
		if (cardDataBuf[CARD_DATA_OFF_STATE_OFFLINE_CARD_LIMIT] != (byte) 0xFF) {
			if (Util.arrayCompare(
					...
					CARD_DATA_OFF_ISSUE_STATE_CODE,
					cdol1Value,
					(short) (terDataInCDOLVOff[CDOLV_OFF_CDOL1_TERMINAL_STATE_CODE] & 0x0FF),
					(short) 0x02) != 0x00) {
		 ...
		 * 如果数据应用货币代码、累计脱机交易金额、累计脱机交易金额限制存在，卡片执行此检查。 如果下面两个条件都满足：
		 * ——交易货币代码等于应用货币代码； ——累计脱机交易金额加本次授权金额大于累计脱机交易金额限制。 卡片： ——设置 CVR
		 * 中“频度检查超过”位为“1”； ——设置卡片请求联机指示位为“1”。
		 */
		if (Util.arrayCompare(cardDataBuf, CARD_DATA_OFF_APPCOINCODE,
				cdol1Value, tradeCoinCodeOff, (short) 0x02) == 0x00) {
			if (!PBOCUtil.isAllZero(cardDataBuf,
					CARD_DATA_OFF_TOTAL_CARD_MONEY_LIMIT, (short) 0x06)) {
				PBOCUtil.arrayDecAdd(abyCurTradeCardData,
						CARD_DATA_OFF_TOTAL_OFFILINE_MONEY, cdol1Value,
						tradeAuthMoneyOff, tmpBuf, (short) 0x00);
				if (PBOCUtil.arrayCompare(tmpBuf, (short) 0x00, cardDataBuf,
						CARD_DATA_OFF_TOTAL_CARD_MONEY_LIMIT, (short) 0x06) == 0x01) {
					PBOCUtil.setBit(abyPBOCTradeSession,
							TRADE_SESSION_DATA_OFF_CVR,
							CVR_OFF_EXCEED_FREQ_CHECK);
					tradeResult = TRADE_RESULT_ARQC;
		 ...
		 * 如果数据应用货币代码、第2应用货币代码、货币转换因子、累计脱机交易金额（双货币）、累计 脱机交易金额限制（双货币）存在，卡片执行此检查。
		 * ——如果交易货币代码等于应用货币代码，累计脱机交易金额（双货币）加本次授权金额和累计脱机交易金额限制（双货币）进行比较；
		 * ——如果交易货币代码等于第 2 应用货币代码， 使用货币转换因子将授权金额转换为近似的应用货币代码金额。 累计脱机交易金额 （双货币）
		 * 加这个近似的授权金额和累计脱机交易金额限制 （双货币）进行比较； ——如果比较的结果是大于了限制数，卡片应该采取以下措施： ● 设置
		 * CVR 中“频度检查超过”位为“1”； ● 设置卡片请求联机指示位为“1”。
		 */
		if (!PBOCUtil.isAllZero(cardDataBuf,
				CARD_DATA_OFF_DCOIN_TOTAL_CARD_MONEY_LIMIT, (short) 0x06)) {
			if (Util.arrayCompare(cardDataBuf, CARD_DATA_OFF_APPCOINCODE,
					cdol1Value, tradeCoinCodeOff, (short) 0x02) == 0x00) {
				PBOCUtil.arrayDecAdd(abyCurTradeCardData,
						CARD_DATA_OFF_DCOINTOTAL_OFFILINE_MONEY, cdol1Value,
						tradeAuthMoneyOff, tmpBuf, (short) 0x00);
				if (PBOCUtil.arrayCompare(tmpBuf, (short) 0x00, cardDataBuf,
						CARD_DATA_OFF_DCOIN_TOTAL_CARD_MONEY_LIMIT,
						(short) 0x06) == 0x01) {
			...
			} else if (Util.arrayCompare(cardDataBuf,
					CARD_DATA_OFF_SECOND_APP_COIN_CODE, cdol1Value,
					tradeCoinCodeOff, (short) 0x02) == 0x00) {
				PBOCUtil.arrayDecAdd(abyCurTradeCardData,
						CARD_DATA_OFF_DCOINTOTAL_OFFILINE_MONEY,
						abyPBOCTradeSession,
						TRADE_SESSION_DATA_OFF_TRADE_AUTH_NEAR_MONEY, tmpBuf,
						(short) 0x00);
				if (PBOCUtil.arrayCompare(tmpBuf, (short) 0x00, cardDataBuf,
						CARD_DATA_OFF_DCOIN_TOTAL_CARD_MONEY_LIMIT,
						(short) 0x06) == 0x01) {
		...
		/**
		 * 11. 新卡检查 此检查可选。如果卡片是新卡，交易请求联机。新卡是指从来没有联机接受过的卡片。
		 * 如果数据上次联机ATC寄存器、应用缺省行为存在，卡片执行此检查。 如果上次联机ATC寄存器值为零，卡片应该采取以下措施： ——设置 CVR
		 * 中“新卡”位为“1”； ——如果 ADA 中“如果新卡，交易联机”位为“1”，设置卡片请求联机指示位为“1”。
		 */
		if (PBOCUtil.isAllZero(abyCurTradeCardData,
				CARD_DATA_OFF_PREONLINE_ATC, (short) 0x02)) {
			PBOCUtil.setBit(abyPBOCTradeSession, TRADE_SESSION_DATA_OFF_CVR,
					CVR_OFF_NEW_CARD);
			if (PBOCUtil.isBitSet(cardDataBuf, CARD_DATA_OFF_ADA,
					ADA_OFF_NEW_CARD)) {
		 ...
		 * 如果执行此检查，卡片中要有应用缺省行为（ADA）数据。 如果下列所有条件成立： ——卡片支持脱机 PIN 验证；
		 * ——卡片没有收到过验证命令； ——PIN 尝试计数器已经为零。 卡片要执行下列操作： ——设置 CVR 中“PIN
		 * 尝试限制数超过”位为“1”； ——如果 ADA 中“如果上次交易 PIN
		 * 尝试限制数超过，交易拒绝”位为“1”，设置卡片请求拒绝指示位为“1”； ——如果 ADA 中“如果上次交易 PIN
		 * 尝试限制数超过，交易联机”位为“1”，设置卡片请求联机指示位为“1”； ——如果 ADA 中“如果上次交易 PIN
		 * 尝试限制数超过，交易拒绝并锁应用”位为“1”，拒绝交易并锁应用。
		 */
		if ((paramBuf[PBOC_PARAM_OFF_PIN_MAX_CNTR] != 0x00)
				&& (paramBuf[PBOC_PARAM_OFF_PIN_LEFT_CNTR] == 0x00)
			...
			PBOCUtil.setBit(abyPBOCTradeSession, TRADE_SESSION_DATA_OFF_CVR,
					CVR_OFF_PIN_BLOCKED);
			if (PBOCUtil.isBitSet(cardDataBuf, CARD_DATA_OFF_ADA,
					ADA_OFF_LAST_TRADE_PIN_VERIFY_EXCEED_AAC)) {
				tradeResult = TRADE_RESULT_AAC;
			} else if (PBOCUtil.isBitSet(cardDataBuf, CARD_DATA_OFF_ADA,
					ADA_OFF_LAST_TRADE_PIN_VERIFY_EXCEED_ARQC)) {
				tradeResult = TRADE_RESULT_ARQC;
			} else if (PBOCUtil.isBitSet(cardDataBuf, CARD_DATA_OFF_ADA,
					ADA_OFF_LAST_TRADE_PIN_VERIFY_EXCEED_AAC_LOCK_APP)) {
	...
	private void updateTradeLog(short[] logTemplate, byte[] tmpBuf) {
		...
		while (i < sLogTemplateLen) {
			...
			case LOG_VALUE_TYPE_PDOL:
				sTradeLogLen = Util.arrayCopyNonAtomic(pdolValue,
						logTemplate[(short) (i + 0x01)], tmpBuf, sTradeLogLen,
						logTemplate[(short) (i + 0x02)]);
				break;
			case LOG_VALUE_TYPE_CDOL1:
				sTradeLogLen = Util.arrayCopyNonAtomic(cdol1Value,
						logTemplate[(short) (i + 0x01)], tmpBuf, sTradeLogLen,
						logTemplate[(short) (i + 0x02)]);
				break;
			case LOG_VALUE_TYPE_CDOL2:
				sTradeLogLen = Util.arrayCopyNonAtomic(cdol2Value,
						logTemplate[(short) (i + 0x01)], tmpBuf, sTradeLogLen,
						logTemplate[(short) (i + 0x02)]);
				break;
			case LOG_VALUE_TYPE_CARD:
				sTradeLogLen = Util.arrayCopyNonAtomic(cardDataBuf,
						logTemplate[(short) (i + 0x01)], tmpBuf, sTradeLogLen,
						logTemplate[(short) (i + 0x02)]);
				break;
			default:
				sTradeLogLen = Util.arrayFillNonAtomic(tmpBuf, sTradeLogLen,
						logTemplate[(short) (i + 0x02)], (byte) 0x00);
				break;
			}
		...
		short sDstOffset = LOG_INFO_OFF_CONTENT;
		while (sOffset < fileSize) {
			if (PBOCUtil.arrayCompare(tradeLogFile, sOffset, tradeLogFile,
					sDstOffset, (short) 0x04) == 1) {
				sDstOffset = sOffset;
			}
		...
		// increase counter
		PBOCUtil.arrayHexAdd(tradeLogFile, sDstOffset, LOG_INCREASE_VAR,
				(short) 0x00, tmpBuf, (short) 0x00, (short) 0x04);
		...
		// write trade log
		Util.arrayCopyNonAtomic(tmpBuf, (short) 0x00, tradeLogFile, sDstOffset,
				sTradeLogLen);
	}
	 ...
	 *            before value buffer
	 * @param sBeforeOff
	 *            before value buffer offset
	 * @param afterValue
	 *            after value buffer
	 * @param sAfterOff
	 *            after value buffer offset
	 * @param sTag
	 *            tag
	 * @param abyCurTradeCDOL
	 *            CDOL
	 ...
	 *            temp buffer
	 */
	private void updateChargeLog(byte[] beforeValue, short sBeforeOff,
			byte[] afterValue, short sAfterOff, short sTag,
			byte[] abyCurTradePDOL, byte[] tmpBuf) {
		if (chargeLogFile == null) {
			return;
		}
		...
		sLen = Util.arrayCopyNonAtomic(beforeValue, sBeforeOff, tmpBuf, sLen,
				(short) 0x06);
		sLen = Util.arrayCopyNonAtomic(afterValue, sAfterOff, tmpBuf, sLen,
				(short) 0x06);
		...
		while (i < logFormatLen) {
			...
			short sOff = PBOCUtil.findValuePosInTLList(sTag, cdol1,
					(short) 0x00, (short) cdol1.length);
			if (sOff != PBOCUtil.TAG_NOT_FOUND) {
				sLen = Util.arrayCopyNonAtomic(cdol1Value, sOff, tmpBuf, sLen,
						sValueLen);
			...
			// if not find in cdol1 then find in cdol2
			sOff = PBOCUtil.findValuePosInTLList(sTag, cdol2, (short) 0x00,
					(short) cdol2.length);
			if (sOff != PBOCUtil.TAG_NOT_FOUND) {
				sLen = Util.arrayCopyNonAtomic(cdol2Value, sOff, tmpBuf, sLen,
						sValueLen);
			...
			sOff = PBOCUtil.findValuePosInTLList(sTag, abyCurTradePDOL,
					(short) 0x00, sPDOLLen);
			if (sOff != PBOCUtil.TAG_NOT_FOUND) {
				sLen = Util.arrayCopyNonAtomic(pdolValue, sOff, tmpBuf, sLen,
						sValueLen);
			...
			if (sOff == INVALID_VALUE) {
				sLen = Util.arrayFillNonAtomic(tmpBuf, sLen, sValueLen,
						(byte) 0x00);
			} else {
				sLen = Util
						.arrayCopyNonAtomic(
								cardDataBuf,
								analyseTable[(short) (sOff + ANALYSE_TABLE_OFF_VALUE_OFF)],
								tmpBuf, sLen, sValueLen);
			}
		}
		...
		// increase counter
		PBOCUtil.arrayHexAdd(chargeLogFile, sDstOffset, LOG_INCREASE_VAR,
				(short) 0x00, tmpBuf, (short) 0x00, (short) 0x04);
		...
		// write trade log
		Util.arrayCopyNonAtomic(tmpBuf, (short) 0x00, chargeLogFile,
				sDstOffset, sLen);
	}
	 ...
	 *            temp buffer
	 */
	private void updateTradeData(byte tradeResult, byte[] abyCurTradeCDOLValue,
			byte[] tmpBuf) {
		if (tradeResult == TRADE_RESULT_ARQC) {
			Util.arrayCopy(
					abyCurTradeCardData,
					CARD_DATA_OFF_LAST_TRADE_EXCUTE_CMD_CNTR,
					cardDataBuf,
					CARD_DATA_OFF_LAST_TRADE_EXCUTE_CMD_CNTR,
					(short) (CARD_DATA_OFF_LAST_TRADE_REFUSE_DDA_FAILED + 0x01 - CARD_DATA_OFF_LAST_TRADE_EXCUTE_CMD_CNTR));
			return;
		}
		...
		if (tradeResult == TRADE_RESULT_TC) {
			...
			if (abyPBOCTradeSession[TRADE_SESSION_DATA_OFF_GAC_CNTR] == 0x01) {
				...
				/**
				 * 当交易是电子现金交易且脱机同意时将扣除电子现金余额 当卡片进行联机授权时，电子现金交易不扣除卡上余额，而是从主账户扣除
				...
				if (bIsECTrade) {
					...
					PBOCUtil.arrayDecSub(
							abyCurTradeCardData,
							sOff,
							abyCurTradeCDOLValue,
							(short) (terDataInCDOLVOff[CDOLV_OFF_CDOL1_TRADE_AUTH_MONEY] & 0x0FF),
							abyCurTradeCardData, sOff);
				} else {
					/**
					 * 脱机接受累加授权金额 联机授权脱机接受则清除脱机交易金额，累计脱机交易金额不加
					 */
					// 交易货币代码=应用货币代码
					if (Util.arrayCompare(cardDataBuf,
							CARD_DATA_OFF_APPCOINCODE, abyCurTradeCDOLValue,
							tradeCoinCodeOff, (short) 0x02) == 0x00) {
						// 累计脱机交易金额累加授权金额
						PBOCUtil.arrayDecAdd(
								abyCurTradeCardData,
								CARD_DATA_OFF_TOTAL_OFFILINE_MONEY,
								abyCurTradeCDOLValue,
								(short) (terDataInCDOLVOff[CDOLV_OFF_CDOL1_TRADE_AUTH_MONEY] & 0x0FF),
						...
						PBOCUtil.arrayDecAdd(
							...
							CARD_DATA_OFF_SECOND_APP_COIN_CODE,
							abyCurTradeCDOLValue, tradeCoinCodeOff,
							(short) 0x02) == 0x00) {
						// 交易货币代码=第2应用货币代码
						...
						PBOCUtil.arrayDecAdd(abyCurTradeCardData,
								CARD_DATA_OFF_DCOINTOTAL_OFFILINE_MONEY,
								abyPBOCTradeSession,
								TRADE_SESSION_DATA_OFF_TRADE_AUTH_NEAR_MONEY,
								abyCurTradeCardData,
								CARD_DATA_OFF_DCOINTOTAL_OFFILINE_MONEY);
					}
				}
		...
		if (!bIsECTrade) {
			...
			if (abyPBOCTradeSession[TRADE_SESSION_DATA_OFF_GAC_CNTR] == 0x01) {
				// 交易货币代码!=应用货币代码
				if (Util.arrayCompare(cardDataBuf, CARD_DATA_OFF_APPCOINCODE,
						abyCurTradeCDOLValue, tradeCoinCodeOff, (short) 0x02) != 0x00) {
					// 连续脱机交易计数器（国际-货币）加1
					abyCurTradeCardData[CARD_DATA_OFF_INTERCOINOFFLINE_ATC]++;
				}

				if (Util.arrayCompare(cardDataBuf,
						CARD_DATA_OFF_ISSUE_STATE_CODE, abyCurTradeCDOLValue,
						stateCodeOff, (short) 0x02) != 0x00) {
					// 连续脱机交易计数器（国际-国家）加1
		...
		Util.arrayCopy(
				...
				cardDataBuf,
				CARD_DATA_OFF_AVAILABLE_OFFLINE_MONEY,
				(short) (CARD_DATA_OFF_ATC - CARD_DATA_OFF_AVAILABLE_OFFLINE_MONEY));
	 ...
	 *            apdu buffer
	 * @param bCDA
	 *            true is generate CDA, false is not generate CDA
	 * @param abyCurTradeCDOLValue
	 *            CDOL Value
	 * @return
	 */
	private short generateRsp(byte[] apduBuf, boolean bCDA,
		...
		if (bCDA) {
			// AIP标明卡片不支持CDA
			if (!PBOCUtil.isBitSet(abyPBOCTradeSession,
					TRADE_SESSION_DATA_OFF_AIP, AIP_SUPPORT_OFF_CDA)) {
				ISOException.throwIt(ISO7816.SW_CONDITIONS_NOT_SATISFIED);
			}
			...
			sOff++;
			// 1. 密文信息数据, TLV
			sOff = PBOCUtil.appendTLV(TAG_CID, abyPBOCTradeSession,
					TRADE_SESSION_DATA_OFF_CID, (short) 0x01, apduBuf, sOff);
			// 2. ATC, TLV
			sOff = PBOCUtil.appendTLV(TAG_ATC, cardDataBuf, CARD_DATA_OFF_ATC,
					(short) 0x02, apduBuf, sOff);
			...
			if (abyCurTradeCDOLValue == cdol1Value) {
				...
				Util.arrayCopyNonAtomic(abyPBOCTradeSession,
						TRADE_SESSION_DATA_OFF_AC, abyPBOCTradeSession,
						TRADE_SESSION_DATA_OFF_AUTH_AC, (short) 0x08);
			}

			// 3. 签名的动态应用数据
			sLen = getRSAKeyLen();
			short sTmp = sOff;
			sOff = PBOCUtil.appendTLV(TAG_SIGN_DYNAMIC_APP_DATA, apduBuf, sOff,
					sLen, apduBuf, sOff);
			sOff -= sLen;
			...
			msgDigest
					.update(pdolValue,
							(short) 0x00,
							curTradeConditions[CURRENT_TRADE_CONDITION_OFF_QPBOCPDOL] ? (short) (paramBuf[PBOC_PARAM_OFF_QPBOCPDOLVALUE_LEN] & 0x0FF)
									: (short) (paramBuf[PBOC_PARAM_OFF_PBOCPDOLVALUE_LEN] & 0x0FF));
			msgDigest.update(cdol1Value, (short) 0x00,
					(short) cdol1Value.length);

			short randomOff;
			if (abyCurTradeCDOLValue == cdol2Value) {
				msgDigest.update(cdol2Value, (short) 0x00,
						(short) cdol2Value.length);
				randomOff = (short) (terDataInCDOLVOff[CDOLV_OFF_CDOL2_TERMINAL_TRADE_RANDOM] & 0x0FF);
			} else {
				randomOff = (short) (terDataInCDOLVOff[CDOLV_OFF_CDOL1_TERMINAL_TRADE_RANDOM] & 0x0FF);
			}
			...
			sOff = PBOCUtil.appendTLV(TAG_ISSUE_APP_DATA, pbocIssueAppData,
					(short) 0x00, issueAppDataLen, apduBuf, sOff);
			// 生成发卡行自定义数据
			generateIssueAppData(apduBuf, (short) (sOff - issueAppDataLen),
					issueAppDataLen);

			msgDigest.doFinal(apduBuf, (short) (sTmp + sLen), (short) (sOff
					- sTmp - sLen), apduBuf,
					(short) (sTmp + CDA_OFF_IC_TRADE_HASH));
			...
			// replace ATC
			Util.arrayCopyNonAtomic(cardDataBuf, CARD_DATA_OFF_ATC, apduBuf,
					(short) (sTmp + CDA_OFF_IC_DATA_DIGIT), (short) 0x02);
			// replace CID
			apduBuf[(short) (sTmp + CDA_OFF_IC_DATA_CID)] = abyPBOCTradeSession[TRADE_SESSION_DATA_OFF_CID];
			// replace AC
			Util.arrayCopyNonAtomic(abyPBOCTradeSession,
					TRADE_SESSION_DATA_OFF_AC, apduBuf,
					(short) (sTmp + CDA_OFF_IC_DATA_AC), (short) 0x08);
			Util.arrayFillNonAtomic(apduBuf,
					(short) (sTmp + CDA_OFF_PADDING_BB), (short) (sLen - 57),
					(byte) 0xBB);

			// 计算签名哈希值
			msgDigest.update(apduBuf, (short) (sTmp + CDA_OFF_SIGN_FORMAT),
					(short) (sLen - 22));
			msgDigest.doFinal(abyCurTradeCDOLValue, randomOff, (short) 0x04,
					apduBuf, (short) (sTmp + sLen - 21));
			apduBuf[(short) (sTmp + sLen - 0x01)] = (byte) 0xBC;
			cipherRSA.doFinal(apduBuf, sTmp, sLen, apduBuf, sTmp);

			sLen = (short) (sOff - 2);
			if (sLen > 0x7F) {
				Util.arrayCopyNonAtomic(apduBuf, (short) 0x02, apduBuf,
						(short) 0x03, sLen);
				apduBuf[0x01] = (byte) 0x81;
			...
			// 2. ATC, M, 2 byte
			sOff = Util.arrayCopyNonAtomic(cardDataBuf, CARD_DATA_OFF_ATC,
					apduBuf, sOff, (short) 0x02);
			// cal AC
			generateAppCipher(abyCurTradeCDOLValue);
			// 3. 应用密文, M, 8 byte
			sOff = Util.arrayCopyNonAtomic(abyPBOCTradeSession,
					TRADE_SESSION_DATA_OFF_AC, apduBuf, sOff, (short) 0x08);
			if (abyCurTradeCDOLValue == cdol1Value) {
				// 存储第一条Generate AC指令的应用密文
				Util.arrayCopyNonAtomic(abyPBOCTradeSession,
						TRADE_SESSION_DATA_OFF_AC, abyPBOCTradeSession,
			...
			// 4. 发卡行应用数数据
			short issueAppDataLen = (short) pbocIssueAppData.length;
			sOff = Util.arrayCopyNonAtomic(pbocIssueAppData, (short) 0x00,
					apduBuf, sOff, issueAppDataLen);
			// 生成发卡行自定义数据
			generateIssueAppData(apduBuf, (short) (sOff - issueAppDataLen),
					issueAppDataLen);
	 ...
	 * @param acType
	 *            ac type
	 * @param cardTradeResult
	 *            card trade result
	 * @param bCDA
	 *            true is generate CDA, false is not generate CDA
	 * @return response data length
	 */
	private short getGenerateACRsp_1(byte[] apduBuf, byte acType,
			byte cardTradeResult, boolean bCDA) {
		byte tradeResult;
		...
		if ((acType == GENERATE_AC_TYPE_AAC)
			...
			if (PBOCUtil.isBitSet(abyPBOCTradeSession,
				...
				if (PBOCUtil.isBitSet(cardDataBuf, CARD_DATA_OFF_ADA,
						ADA_OFF_PIN_VERIFY_EXCEED_AND_TRADE_AAC)) {
			...
			// TVR中SDA失败
			if (PBOCUtil
					.isBitSet(cdol1Value, tvrOff, TVR_BIT_OFFSET_SDA_FAILED)) {
				// 设置SDA失败指示位
				abyCurTradeCardData[CARD_DATA_OFF_LAST_TRADE_REFUSE_SDA_FAILED] = 0x01;
			}
			...
			// TVR中CDA/DDA失败
			if (PBOCUtil
					.isBitSet(cdol1Value, tvrOff, TVR_BIT_OFFSET_DDA_FAILED)
					|| PBOCUtil.isBitSet(cdol1Value, tvrOff,
							TVR_BIT_OFFSET_CDA_FAILED)) {
				// 设置DDA失败指示位
				abyCurTradeCardData[CARD_DATA_OFF_LAST_TRADE_REFUSE_DDA_FAILED] = 0x01;
			}
			...
			bCDA = false;
			tradeResult = TRADE_RESULT_AAC;
		} else if ((acType == GENERATE_AC_TYPE_ARQC)
				|| (cardTradeResult == TRADE_RESULT_ARQC)) {
		...
		/**
		 * 1. 第一条Generate AC指令当 交易结束并且应用未锁定时清除交易状态信息 2. 应用锁定后Generate
		 * AC指令均返回AAC，但后续要求可以执行External Auth，Application UnBlock等指令，因此不可清除交易状态信息
		 * 避免交易结束后发送发卡行脚本处理指令 3. PIN锁以后，也不可清除交易状态信息，用于执行发卡行脚本命令解锁PIN???
		 */
		if ((tradeResult != TRADE_RESULT_ARQC)
				&& (appState != APP_STATE_LOCKED)
				&& (paramBuf[PBOC_PARAM_OFF_PIN_LEFT_CNTR] != 0x00)) {
	...
	private void onLineResetSessionData(boolean bType) {
		/**
		 * 复位成0 -联机授权指示器 -SDA 失败指示器 -DDA 失败指示器 -发卡行脚本指令计数器 -发卡行脚本失败指示位
		 */
		Util.arrayFillNonAtomic(
				abyCurTradeCardData,
				CARD_DATA_OFF_LAST_TRADE_EXCUTE_CMD_CNTR,
				(short) (CARD_DATA_OFF_CARD_TRADE_ATTRIBUTE - CARD_DATA_OFF_LAST_TRADE_EXCUTE_CMD_CNTR),
				(byte) 0x00);
		if (bType) {
			/**
			 * 清除 -累计脱机交易金额 -累计脱机交易金额（双货币） -连续脱机交易计数器（国际-货币） -连续脱机交易计数器（国际-国家）
			 */
			Util.arrayFillNonAtomic(abyCurTradeCardData,
					CARD_DATA_OFF_TOTAL_OFFILINE_MONEY, (short) 0x06,
					(byte) 0x00);
			Util.arrayFillNonAtomic(abyCurTradeCardData,
					CARD_DATA_OFF_DCOINTOTAL_OFFILINE_MONEY, (short) 0x06,
					(byte) 0x00);
			abyCurTradeCardData[CARD_DATA_OFF_INTERCOINOFFLINE_ATC] = 0x00;
			abyCurTradeCardData[CARD_DATA_OFF_INTERSTATEOFFLINE_ATC] = 0x00;
			// 上次联机ATC寄存器=ATC
			Util.arrayCopyNonAtomic(cardDataBuf, CARD_DATA_OFF_ATC,
					abyCurTradeCardData, CARD_DATA_OFF_PREONLINE_ATC,
					(short) 0x02);
		}
	}
	 ...
	 * @return
	 */
	private short getGenerateACRsp_2(byte[] apduBuf, boolean bCDA,
			boolean bAuth, byte acType, byte cardTradeResult) {
		// true 响应码不是拒绝; false 响应码表示拒绝
		boolean bAccept = false;
		// true 卡片接受; false 卡片拒绝
		boolean bFlag = true;
		boolean bIsSupportExtAuth = PBOCUtil.isBitSet(abyPBOCTradeSession,
				TRADE_SESSION_DATA_OFF_AIP, AIP_SUPPORT_OFF_ISSUE_AUTH);
		...
		if (bAuth) {
			/**
			 * 检查第 2 个生成应用密文（GENERATE AC）命令中的 P1 参数： 如果 P1 表明请求
			 * TC（接受交易）而且授权响应码表明发卡行接受或推荐，执行交易接受 处理。见 16.6.2 中的描述； 如果 P1 表明请求
			 * AAC（拒绝交易）或者授权响应码表明发卡行拒绝，执行交易拒绝处理。 见 16.6.1 中的描述。
			 */
			if ((Util.arrayCompare(AUTH_CODE_00, (short) 0x00, cdol2Value,
					authCodeOff, (short) 0x02) == 0x00)
					|| (Util.arrayCompare(AUTH_CODE_10, (short) 0x00,
							cdol2Value, authCodeOff, (short) 0x02) == 0x00)
					|| (Util.arrayCompare(AUTH_CODE_11, (short) 0x00,
							cdol2Value, authCodeOff, (short) 0x02) == 0x00)
					|| (Util.arrayCompare(AUTH_CODE_01, (short) 0x00,
							cdol2Value, authCodeOff, (short) 0x02) == 0x00)
					|| (Util.arrayCompare(AUTH_CODE_02, (short) 0x00,
							cdol2Value, authCodeOff, (short) 0x02) == 0x00)
					|| (Util.arrayCompare(AUTH_CODE_Y1, (short) 0x00,
							cdol2Value, authCodeOff, (short) 0x02) == 0x00)) {
				bAccept = true;
			}
			...
			if (bAccept
				...
				/**
				 * 如果发卡行认证执行，检查在外部认证命令中送来的授权响应码 授权响应码为 00，10 或11 表明发卡行接受交易；
				 * 授权响应码为 01 或02 表明发卡行请求参考 其它值表明发卡行拒绝，卡片按照终端请求交易拒绝进行处理
				 */
				if ((Util
						.arrayCompare(AUTH_CODE_00, (short) 0x00,
								abyPBOCTradeSession,
								TRADE_SESSION_DATA_OFF_EXTERNAL_AUTH_CODE,
								(short) 0x02) == 0x00)
						|| (Util.arrayCompare(AUTH_CODE_10, (short) 0x00,
								abyPBOCTradeSession,
								TRADE_SESSION_DATA_OFF_EXTERNAL_AUTH_CODE,
				...
				if (bIsSupportExtAuth) {
					...
					if (extAuthCmdCntr == 0x00) {
						...
						if ((cardDataBuf[CARD_DATA_OFF_ISSUE_AUTH_INDICATE] & (byte) 0x80) == (byte) 0x80) {
							...
							if (PBOCUtil.isBitSet(cardDataBuf,
									CARD_DATA_OFF_ADA,
									ADA_OFF_ISSUE_AUTH_M_NO_ARPC)) {
								bFlag = false;
							}
						}
					} else {
						...
						if ((abyCurTradeCardData[CARD_DATA_OFF_LAST_TRADE_ISSUE_AUTH_FAILED] == 0x01)
								&& PBOCUtil.isBitSet(cardDataBuf,
										CARD_DATA_OFF_ADA,
										ADA_OFF_ISSUE_AUTH_EXEC_FAILED)) {
							bFlag = false;
						}
					}
				}
				...
				if (bFlag) {
					...
					if (bIsSupportExtAuth) {
						...
						if (extAuthCmdCntr == 0x00) {
							...
							PBOCUtil.setBit(abyPBOCTradeSession,
									TRADE_SESSION_DATA_OFF_CVR,
									CVR_OFF_ONLINE_AUTHED_ISSUE_AUTH_UNEXEC);
					...
					if (PBOCUtil.isBitSet(cardDataBuf, CARD_DATA_OFF_ADA,
							ADA_OFF_TRADE_REFUST_ISSUE_AUTH_FAILED)) {
						// 设置CID“需要通知”位=1
						abyPBOCTradeSession[TRADE_SESSION_DATA_OFF_CID] |= CID_REQUEST_MSG;
					}
			...
			if (Util.arrayCompare(
					...
					CARD_DATA_OFF_ISSUE_STATE_CODE,
					cdol2Value,
					(short) (terDataInCDOLVOff[CDOLV_OFF_CDOL2_TERMINAL_STATE_CODE] & 0x0FF),
					(short) 0x02) != 0x00) {
				// 连续脱机交易计数器（国际-国家）加1
				abyCurTradeCardData[CARD_DATA_OFF_INTERSTATEOFFLINE_ATC]++;
			}
			...
			// 交易货币代码!=应用货币代码
			if (Util.arrayCompare(cardDataBuf, CARD_DATA_OFF_APPCOINCODE,
					cdol2Value, tradeCoinCode, (short) 0x02) != 0x00) {
				// 连续脱机交易计数器（国际-货币）加1
				abyCurTradeCardData[CARD_DATA_OFF_INTERCOINOFFLINE_ATC]++;
			}
			...
			if ((acType == GENERATE_AC_TYPE_AAC)
				...
				if (PBOCUtil.isBitSet(cdol2Value, tvrOff,
						TVR_BIT_OFFSET_SDA_FAILED)) {
					// 设置SDA失败指示位
					abyCurTradeCardData[CARD_DATA_OFF_LAST_TRADE_REFUSE_SDA_FAILED] = 0x01;
				} else if (PBOCUtil.isBitSet(cdol2Value, tvrOff,
						TVR_BIT_OFFSET_DDA_FAILED)
						|| PBOCUtil.isBitSet(cdol2Value, tvrOff,
								TVR_BIT_OFFSET_CDA_FAILED)) {
					// 设置DDA失败指示位
					abyCurTradeCardData[CARD_DATA_OFF_LAST_TRADE_REFUSE_DDA_FAILED] = 0x01;
				}
				...
				if (Util.arrayCompare(cardDataBuf, CARD_DATA_OFF_APPCOINCODE,
					...
					PBOCUtil.arrayDecAdd(
							...
							CARD_DATA_OFF_TOTAL_OFFILINE_MONEY,
							cdol2Value,
							(short) (terDataInCDOLVOff[CDOLV_OFF_CDOL2_TRADE_AUTH_MONEY] & 0x0FF),
							abyCurTradeCardData,
							CARD_DATA_OFF_TOTAL_OFFILINE_MONEY);
					// 累计脱机交易金额（双货币）累加授权金额
					PBOCUtil.arrayDecAdd(
						...
						CARD_DATA_OFF_SECOND_APP_COIN_CODE, cdol2Value,
						tradeCoinCode, (short) 0x02) == 0x00) {
					// 交易货币代码=第2应用货币代码
					// 累计脱机交易金额（双货币）累加近似授权金额
					PBOCUtil.arrayDecAdd(abyCurTradeCardData,
							CARD_DATA_OFF_DCOINTOTAL_OFFILINE_MONEY,
	...
	private void onGenerateAC(APDU apdu) {
		...
		Util.arrayCopyNonAtomic(apduBuf, ISO7816.OFFSET_CDATA,
				abyCurTradeCDOLValue, (short) 0x00,
				(short) abyCurTradeCDOLValue.length);

		// 根据货币转换因子转换近似授权金额
		if (!PBOCUtil.isAllZero(cardDataBuf, CARD_DATA_OFF_COIN_CONVERT_GENE,
				(short) 0x04)) {
			Util.arrayFillNonAtomic(apduBuf, (short) 0x00, (short) 33,
					(byte) 0x00);

			Util.arrayCopyNonAtomic(abyCurTradeCDOLValue, tradeAuthMoneyOff,
					apduBuf, (short) 0x00, (short) 0x06);
			Util.arrayCopyNonAtomic(cardDataBuf,
					CARD_DATA_OFF_COIN_CONVERT_GENE, apduBuf, (short) 0x08,
					(short) 0x04);
			// 货币转换因子 4 byte
			...
			PBOCUtil.arrayDecMul(apduBuf, (short) 0x00, apduBuf, (short) 0x06,
					apduBuf, (short) 12, gene);

			Util.arrayCopyNonAtomic(apduBuf, (short) 12, abyPBOCTradeSession,
					TRADE_SESSION_DATA_OFF_TRADE_AUTH_NEAR_MONEY, (short) 0x06);
		}
		...
		if (abyPBOCTradeSession[TRADE_SESSION_DATA_OFF_TRADE_TYPE] != TRADE_TYPE_EC) {
			if (Util.arrayCompare(abyCurTradeCDOLValue, tradeCoinCodeOff,
					cardDataBuf, CARD_DATA_OFF_APPCOINCODE, (short) 0x02) == 0x00) {
				curTradeConditions[CURRENT_TRADE_CONDITION_OFF_SECOND_COIN_TRADE] = false;
			} else if (Util.arrayCompare(abyCurTradeCDOLValue,
					tradeCoinCodeOff, cardDataBuf,
					CARD_DATA_OFF_EC_SECOND_APP_COIN_CODE, (short) 0x02) == 0x00) {
		...
		if (cmdCntr == 0x00) {
			// card risk manager
			cardTradeResult = cardRiskManager_1(acType, abyCurTradePDOL,
					apduBuf);
			// gete response data
			...
			short authCodeOff = (short) (terDataInCDOLVOff[CDOLV_OFF_CDOL2_AUTH_CODE] & 0x0FF);
			if ((Util.arrayCompare(AUTH_CODE_Y3, (short) 0x00, cdol2Value,
					authCodeOff, (short) 0x02) == 0x00)
					|| (Util.arrayCompare(AUTH_CODE_Z3, (short) 0x00,
							cdol2Value, authCodeOff, (short) 0x02) == 0x00)) {
				// 联机授权没完成, 执行卡片风险管理
				/**
				 * 1. 连续脱机交易上限频度检查 此检查可选。检查连续脱机交易次数是否超过了最大限制。 如果上次联机ATC寄存器和JR/T
				 * 0025专有数据：连续脱机交易上限（标签“9F59”）存在，卡片执行此检查。
				 * 如果ATC和上次联机ATC寄存器的差值大于连续脱机交易上限，卡片： ——设置 CVR 中“频度检查超过”位为“1”；
				...
				/**
				 * 2. 新卡检查 此检查可选。检查以前是否有过联机接受的交易。
				 * 如果卡片中上次联机ATC寄存器存在，卡片执行此检查。如果ADA不存在，卡片认为缺省为零。
				 * 如果上次联机ATC寄存器值为零，卡片： ——设置 CVR 中“新卡”位为“1”； ——如果 ADA
				 * 中“如果是新卡而且交易无法联机
				 * ，交易拒绝”位为“1”，设置卡片请求脱机拒绝指示位为“1”。在卡片风险管理后，卡片返回交易拒绝。
				 */
				if (PBOCUtil.isAllZero(abyCurTradeCardData,
						CARD_DATA_OFF_PREONLINE_ATC, (short) 0x02)) {
					PBOCUtil.setBit(abyPBOCTradeSession,
							TRADE_SESSION_DATA_OFF_CVR, CVR_OFF_NEW_CARD);
					if (PBOCUtil.isBitSet(cardDataBuf, CARD_DATA_OFF_ADA,
							ADA_OFF_NEW_CARD_CANNOT_ARQC)) {
						cardTradeResult = TRADE_RESULT_AAC;
					}
				}

				/**
				 * 3. PIN尝试限制数超过检查 此项检查可选，检查PIN尝试限制数是否在之前的交易中就已经超过。
				 * 如果卡片中没有ADA数据，卡片认为ADA值缺省为零。
				 * 如果卡片支持脱机PIN验证，而且在本次交易中，卡片没有收到过验证命令，卡片： ——如果 PIN
				 * 尝试计数器已经为零，而且如果 ADA 中“如果上次交易 PIN 尝试限制数超过而且交易无法联机，交易拒绝”位为“1”：
				 * 设置卡片请求脱机拒绝指示位为“1”； 设置 CVR 中“PIN 尝试限制数超过”位为“1”。
				 */
				if ((paramBuf[PBOC_PARAM_OFF_PIN_MAX_CNTR] != 0x00)
						&& (paramBuf[PBOC_PARAM_OFF_PIN_LEFT_CNTR] == 0x00)
						&& (abyPBOCTradeSession[TRADE_SESSION_DATA_OFF_VERIFY_PIN_CNTR] == 0x00)
						&& PBOCUtil
								.isBitSet(cardDataBuf, CARD_DATA_OFF_ADA,
										ADA_OFF_LAST_TRADE_PIN_VERIFY_EXCEED_CANNOT_ARQC_AAC)) {
					cardTradeResult = TRADE_RESULT_AAC;
					PBOCUtil.setBit(abyPBOCTradeSession,
							TRADE_SESSION_DATA_OFF_CVR, CVR_OFF_PIN_BLOCKED);
				}
				...
				/**
				 * 4. 累计脱机交易金额（上限）频度检查 此检查可选。检查使用指定货币的连续脱机交易累计金额是否超过了最大限制数。
				 * 如果累计脱机交易金额和累计脱机交易金额上限数据存在，卡片执行此检查。
				 * 如果累计脱机交易金额加本次授权金额大于累计脱机交易金额上限。 卡片： ——设置 CVR 中频度检查超过位为“1”；
				 * ——设置卡片请求脱机拒绝指示位为“1”。
				 */
				if (!PBOCUtil.isAllZero(cardDataBuf,
						CARD_DATA_OFF_TOTAL_CARD_MONEY_UPLIMIT, (short) 0x06)) {
					PBOCUtil.arrayDecAdd(abyCurTradeCardData,
							CARD_DATA_OFF_TOTAL_OFFILINE_MONEY, cdol2Value,
							authMoneyOff, apduBuf, (short) 0x00);
					if (PBOCUtil.arrayCompare(apduBuf, (short) 0x00,
							cardDataBuf,
							CARD_DATA_OFF_TOTAL_CARD_MONEY_UPLIMIT,
							(short) 0x06) == 1) {
						PBOCUtil.setBit(abyPBOCTradeSession,
					 ...
					 * 卡片： ——设置 CVR 中频度检查超过位为“1”； ——设置卡片请求脱机拒绝指示位为“1”。
					 */
					if (Util.arrayCompare(
							cardDataBuf,
							CARD_DATA_OFF_APPCOINCODE,
							cdol2Value,
							(short) (terDataInCDOLVOff[CDOLV_OFF_CDOL2_TRADE_COIN_CODE] & 0x0FF),
							(short) 0x02) == 0x00) {
						PBOCUtil.arrayDecAdd(abyCurTradeCardData,
								CARD_DATA_OFF_DCOINTOTAL_OFFILINE_MONEY,
								cdol2Value, authMoneyOff, apduBuf, (short) 0x00);
					} else {
						PBOCUtil.arrayDecAdd(abyCurTradeCardData,
								CARD_DATA_OFF_DCOINTOTAL_OFFILINE_MONEY,
								abyPBOCTradeSession,
				...
				PBOCUtil.setBit(abyPBOCTradeSession,
						TRADE_SESSION_DATA_OFF_CVR, CVR_OFF_CANNOT_ONLINE);

				sLen = getGenerateACRsp_2(apduBuf, bCDA, false, acType,
						cardTradeResult);
			} else {
				// 授权响应码不是Y3或Z3表明是联机授权交易
				sLen = getGenerateACRsp_2(apduBuf, bCDA, true, acType,
						cardTradeResult);
			}
		}
	...
	private void onVerifyPIN(APDU apdu) {
		...
		if (Util.arrayCompare(apduBuf, (short) 0x06, paramBuf,
				PBOC_PARAM_OFF_PIN_VALUE, (short) 0x06) != 0x00) {
			retryCntr--;
			// 设置CVR中“脱机PIN验证失败”位
			PBOCUtil.setBit(abyPBOCTradeSession, TRADE_SESSION_DATA_OFF_CVR,
					CVR_OFF_OFFLINE_PIN_FAILED);
			if (retryCntr == 0x00) {
				...
				if (PBOCUtil.isBitSet(cardDataBuf, CARD_DATA_OFF_ADA,
						ADA_OFF_PIN_VERIFY_EXCEED_LOCK_APP)) {
					// 设置CVR中“因为PIN尝试限制数超过，锁应用”位
					PBOCUtil.setBit(abyPBOCTradeSession,
							TRADE_SESSION_DATA_OFF_CVR,
							CVR_OFF_PIN_LOCK_LOCK_APP);
					// 锁应用
					appState = APP_STATE_LOCKED;
				}
			}
		...
		// 清除CVR中“脱机PIN验证失败”位
		PBOCUtil.clearBit(abyPBOCTradeSession, TRADE_SESSION_DATA_OFF_CVR,
				CVR_OFF_OFFLINE_PIN_FAILED);
	}
	...
	private void unWrap(byte[] buf) {
		...
		signMac.update(cardDataBuf, CARD_DATA_OFF_ATC, (short) 0x02);
		// AC 8 byte
		signMac.update(abyPBOCTradeSession, TRADE_SESSION_DATA_OFF_AUTH_AC,
				(short) 0x08);
		...
		if (Util.arrayCompare(sessionKey, (short) 0, buf, (short) (5 + p3),
				(short) 0x04) != 0x00) {
			// ISL010 Test Case
	...
	private void issueScriptTradeFlowCheck() {
		...
		byte tradeState = abyPBOCTradeSession[TRADE_SESSION_DATA_OFF_STATE];
		if ((tradeState != TRADE_STATE_CARD_ACTION_ANALYSE)
				&& (tradeState != TRADE_STATE_ON_LINE)) {
			/**
			 * for DUS006 Test 发卡行认证不成功批准交易联机时，卡片拒绝MAC正确的命令
			 */
			ISOException.throwIt(ISO7816.SW_CONDITIONS_NOT_SATISFIED);
	...
	private void getAllPreAuthTradeMoney(byte[] buf, short sOff) {
		...
		for (short i = 0x00; i < size; i += 0x09) {
			if (extendPreAuthContext[i] != 0x00) {
				PBOCUtil.arrayDecAdd(buf, sOff, extendPreAuthContext,
						(short) (i + EXT_PREAUTH_CONTEXT_OFF_MONEY), buf, sOff);
			}
		}
	}
	...
	private boolean getPreAuthTradeMoney(byte[] buf, short sOff) {
		...
		for (short i = 0x00; i < size; i += 0x09) {
			if ((extendPreAuthContext[(short) (i + EXT_PREAUTH_CONTEXT_OFF_SFI)] == abyPBOCTradeSession[TRADE_SESSION_DATA_OFF_EXT_APP_CUR_SFI])
					&& (Util.arrayCompare(extendPreAuthContext,
							(short) (i + EXT_PREAUTH_CONTEXT_OFF_ID),
							abyPBOCTradeSession,
							TRADE_SESSION_DATA_OFF_EXT_APP_CUR_ID, (short) 0x02) == 0x00)) {
				Util.setShort(abyPBOCTradeSession,
						TRADE_SESSION_DATA_OFF_EXT_CUR_CONTEXT_OFF, i);
				if (buf != null) {
					Util.arrayCopyNonAtomic(extendPreAuthContext,
							(short) (i + EXT_PREAUTH_CONTEXT_OFF_MONEY), buf,
							sOff, (short) 0x06);
				}
	...
	private boolean getPreAuthContextSpace() {
		...
		short size = (short) extendPreAuthContext.length;
		for (short i = 0x00; i < size; i += 0x09) {
			if (PBOCUtil.isAllZero(extendPreAuthContext,
					(short) (i + EXT_PREAUTH_CONTEXT_OFF_ID), (short) 0x02)) {
				Util.setShort(abyPBOCTradeSession,
						TRADE_SESSION_DATA_OFF_EXT_CUR_CONTEXT_OFF, i);
				return true;
			}
	...
	private void flushCacheData() {
		...
		while (i < sCacheLen) {
			...
			if ((fileIndex == (byte) 0xFF) && (sFileOff == INVALID_VALUE)) {
				short sRecLen = Util.getShort(extendlogFile,
						LOG_INFO_OFF_RECLEN);
				...
				short sDstOffset = LOG_INFO_OFF_CONTENT;
				while (sOffset < fileSize) {
					if (PBOCUtil.arrayCompare(extendlogFile, sOffset,
							extendlogFile, sDstOffset, (short) 0x04) == 1) {
						sDstOffset = sOffset;
					}
				...
				// increase counter
				PBOCUtil.arrayHexAdd(extendlogFile, sDstOffset,
						LOG_INCREASE_VAR, (short) 0x00, extendFileCache, i,
						(short) 0x04);

				if (!PBOCUtil
						.isAllZero(extendlogFile, sDstOffset, (short) 0x04)) {
					sDstOffset += sRecLen;
					if (sDstOffset == fileSize) {
						sDstOffset = LOG_INFO_OFF_CONTENT;
					}
				...
				Util.arrayCopyNonAtomic(extendFileCache, i, extendlogFile,
						sDstOffset, sDataLen);
			} else {
				// normal extend application file
				Util.arrayCopyNonAtomic(extendFileCache, i,
						(byte[]) extAppFiles[fileIndex],
						(short) (sFileOff + EXT_APP_RECORD_OFF_ID), sDataLen);
			}
	 ...
	 * 
	 * @param extFileIndex
	 *            extend application file index
	 * @param sFileOffset
	 *            extend application file offset
	 * @param data
	 *            update data buffer
	 * @param sOff
	 *            update data buffer offset
	 * @param sLen
	 *            update data length
	 * @param sMaxRecLen
	 *            max record length
	 */
	private void cacheUpdateCAPPData(byte extFileIndex, short sFileOffset,
			byte[] data, short sOff, short sLen) {
		short sCacheLen = extendFileCacheCurLen[0x00];
		...
		sCacheLen = Util.arrayCopyNonAtomic(data, sOff, extendFileCache,
				sCacheLen, sLen);
	...
	private void onPutData(APDU apdu) {
		...
		case TAG_CAPP_SP_DEDUCTION_LIMIT:
			if (PBOCUtil.arrayCompare(abyCurTradeCardData,
					CARD_DATA_OFF_SP_DEDUCTION_MONEY, apduBuf,
					ISO7816.OFFSET_CDATA, (short) 0x06) == 0x01) {
				ISOException.throwIt(ISO7816.SW_WRONG_DATA);
			}

			// DF62 + 9F77 < 999999999999
			Util.arrayFillNonAtomic(apduBuf, (short) 0x10, (short) 0x06,
					(byte) 0x99);
			PBOCUtil.arrayDecSub(apduBuf, (short) 0x10, cardDataBuf,
					CARD_DATA_OFF_EC_BALANCE_UPLIMIT, apduBuf, (short) 0x10);
			if (PBOCUtil.arrayCompare(apduBuf, ISO7816.OFFSET_CDATA, apduBuf,
					(short) 0x10, (short) 0x06) == 0x01) {
				ISOException.throwIt(ISO7816.SW_CONDITIONS_NOT_SATISFIED);
			}
			break;
		case TAG_EC_BALANCE_LIMIT:
			...
			Util.arrayFillNonAtomic(apduBuf, (short) 0x10, (short) 0x06,
					(byte) 0x99);
			PBOCUtil.arrayDecSub(apduBuf, (short) 0x10, cardDataBuf,
					CARD_DATA_OFF_SP_DEDUCTION_LIMIT, apduBuf, (short) 0x10);
			if (PBOCUtil.arrayCompare(apduBuf, ISO7816.OFFSET_CDATA, apduBuf,
					(short) 0x10, (short) 0x06) == 0x01) {
				ISOException.throwIt(ISO7816.SW_CONDITIONS_NOT_SATISFIED);
			}
		...
		if ((sTag == TAG_EC_BALANCE) || (sTag == TAG_EC_SECOND_BALANCE)) {

			JCSystem.beginTransaction();

			if (sTag == TAG_EC_BALANCE) {
				// 更新9F79值若大于DF63值，则将9F79-DF63后若大于9F77则返回6A80
				if (PBOCUtil.arrayCompare(apduBuf, ISO7816.OFFSET_CDATA,
						abyCurTradeCardData, CARD_DATA_OFF_SP_DEDUCTION_MONEY,
						(short) 0x06) == 0x01) {
					// judge 9F79-DF63 > 9F77
					PBOCUtil.arrayDecSub(apduBuf, ISO7816.OFFSET_CDATA,
							abyCurTradeCardData,
							CARD_DATA_OFF_SP_DEDUCTION_MONEY, apduBuf,
							(short) 0x10);
					if (PBOCUtil.arrayCompare(apduBuf, (short) 0x10,
							cardDataBuf, CARD_DATA_OFF_EC_BALANCE_UPLIMIT,
							(short) 0x06) == 0x01) {
						ISOException.throwIt(ISO7816.SW_WRONG_DATA);
					}
				} else {
					Util.arrayFillNonAtomic(apduBuf, (short) 0x10,
							(short) 0x06, (byte) 0x00);
				}
				...
				PBOCUtil.arrayDecAdd(apduBuf, (short) 0x16, apduBuf,
						(short) 0x10, apduBuf, (short) 0x10);

				if (PBOCUtil.arrayCompare(apduBuf, (short) 0x10, cardDataBuf,
						CARD_DATA_OFF_EC_BALANCE_UPLIMIT, (short) 0x06) == 0x01) {
				...
				if (!PBOCUtil.isAllZero(abyCurTradeCardData,
					...
					if (PBOCUtil.arrayCompare(abyCurTradeCardData,
							CARD_DATA_OFF_SP_DEDUCTION_MONEY, apduBuf,
							ISO7816.OFFSET_CDATA, (short) 0x06) == -1) {
						...
						PBOCUtil.arrayDecSub(abyCurTradeCardData,
								CARD_DATA_OFF_SP_DEDUCTION_MONEY, apduBuf,
								ISO7816.OFFSET_CDATA, abyCurTradeCardData,
								CARD_DATA_OFF_SP_DEDUCTION_MONEY);
						Util.arrayFillNonAtomic(apduBuf, ISO7816.OFFSET_CDATA,
								(short) 0x06, (byte) 0x00);
					}

					// update DF63
					Util.arrayCopyNonAtomic(abyCurTradeCardData,
							CARD_DATA_OFF_SP_DEDUCTION_MONEY, cardDataBuf,
							CARD_DATA_OFF_SP_DEDUCTION_MONEY, (short) 0x06);
				}
			} else {
				if (PBOCUtil.arrayCompare(apduBuf, ISO7816.OFFSET_CDATA,
						cardDataBuf, CARD_DATA_OFF_EC_SECOND_BALANCE_LIMIE,
						(short) 0x06) == 0x01) {
					ISOException.throwIt(ISO7816.SW_CONDITIONS_NOT_SATISFIED);
				}
			}
			...
			Util.arrayCopy(apduBuf, ISO7816.OFFSET_CDATA, cardDataBuf,
					sValueOff, sValueLen);
			updateChargeLog(abyCurTradeCardData, sValueOff, cardDataBuf,
					sValueOff, sTag, abyCurTradePDOL, apduBuf);
			Util.arrayCopyNonAtomic(cardDataBuf, sValueOff,
					abyCurTradeCardData, sValueOff, sValueLen);
	...
	private void onLockCard(APDU apdu) {
		...
		// fot BCTC Test, if is SWP Card and contactless interface, lock card
		// command execute failed
		// if (abyPBOCTradeSession[TRADE_SESSION_DATA_OFF_TRADE_INTERFACE] ==
		// TRADE_INTERFACE_CONTACTLESS) {
		// ISOException.throwIt(ISO7816.SW_CONDITIONS_NOT_SATISFIED);
		// }
	...
	private void onExternalAuth(APDU apdu) {
		...
		/**
		 * 如果在当前交易里，收到过外部认证命令: 1. 设置上次交易指示器中"发卡行认证失败"指示位 2.
		 * 设置CVR中"发卡行认证执行但失败"指示位
		 */
		if (abyPBOCTradeSession[TRADE_SESSION_DATA_OFF_EXT_AUTH_CNTR] > 0x00) {
			abyCurTradeCardData[CARD_DATA_OFF_LAST_TRADE_ISSUE_AUTH_FAILED] = 0x01;
			PBOCUtil.setBit(abyPBOCTradeSession, TRADE_SESSION_DATA_OFF_CVR,
					CVR_OFF_ISSUE_AUTH_EXEC_FAILED);
		...
		// 3. 计算ARPC
		Util.arrayCopyNonAtomic(abyPBOCTradeSession,
				TRADE_SESSION_DATA_OFF_AUTH_AC, apduBuf, (short) 0x10,
				(short) 0x08);
		apduBuf[0x10] ^= apduBuf[sARCOff];
		apduBuf[0x11] ^= apduBuf[(short) (sARCOff + 0x01)];

		cipherECBEncrypt.doFinal(apduBuf, (short) 0x10, (short) 0x08, apduBuf,
				(short) 0x10);

		/**
		 * 发卡行认证失败： 1. 设置上次交易指示器中"发卡行认证失败"指示位 2. 设置 CVR 中“发卡行认证执行但失败”位
		 */
		if (Util.arrayCompare(apduBuf, (short) 0x10, apduBuf,
				ISO7816.OFFSET_CDATA, (short) 0x08) != 0x00) {
			abyCurTradeCardData[CARD_DATA_OFF_LAST_TRADE_ISSUE_AUTH_FAILED] = 0x01;
			PBOCUtil.setBit(abyPBOCTradeSession, TRADE_SESSION_DATA_OFF_CVR,
					CVR_OFF_ISSUE_AUTH_EXEC_FAILED);
		...
		// 获得发卡行授权响应码
		Util.arrayCopyNonAtomic(apduBuf, sARCOff, abyPBOCTradeSession,
				TRADE_SESSION_DATA_OFF_EXTERNAL_AUTH_CODE, (short) 0x02);
		// 清除发卡行认证失败指示位
		abyCurTradeCardData[CARD_DATA_OFF_LAST_TRADE_ISSUE_AUTH_FAILED] = 0x00;
	}
	...
	private void onInternalAuth(APDU apdu) {
		...
		msgDigest.update(ddaTemplate, DDA_OFF_SIGN_FORMAT,
				(short) (DDA_OFF_IC_DATA_DIGIT - DDA_OFF_SIGN_FORMAT));
		msgDigest.update(cardDataBuf, CARD_DATA_OFF_ATC, (short) 0x02);
		msgDigest.update(ddaTemplate, DDA_OFF_PADDING_BB, (short) (sLen
				- DDA_OFF_PADDING_BB - 21));
		msgDigest.update(apduBuf, ISO7816.OFFSET_CDATA, p3);

		Util.arrayCopyNonAtomic(ddaTemplate, (short) 0x00, apduBuf,
				(short) 0x00, sLen);
		msgDigest.doFinal(apduBuf, (short) 0x00, (short) 0x00, apduBuf,
				(short) (sLen - 21));

		// replace ATC
		Util.arrayCopyNonAtomic(cardDataBuf, CARD_DATA_OFF_ATC, apduBuf,
				DDA_OFF_IC_DATA_DIGIT, (short) 0x02);

		cipherRSA.doFinal(apduBuf, (short) 0x00, sLen, apduBuf,
				ISO7816.OFFSET_CDATA);

		sLen = PBOCUtil.appendTLV((short) 0x80, apduBuf, ISO7816.OFFSET_CDATA,
				sLen, apduBuf, (short) 0x00);
	...
	private void onChangeUnBlockPIN(APDU apdu) {
		...
		if (p2 != 0x00) {
			...
			if (p2 == 0x01) {
				Util.arrayFillNonAtomic(sessionKey, (short) 0x00, (short) 0x08,
						(byte) 0x00);
				Util.arrayCopyNonAtomic(paramBuf, PBOC_PARAM_OFF_PIN_VALUE,
						sessionKey, (short) 0x00, (short) 0x06);
				...
				// D4 xor D = D3
				PBOCUtil.arrayXor(apduBuf,
						(short) (ISO7816.OFFSET_CDATA + 0x01), sessionKey,
						(short) 0x00, (short) 0x08);
			}

			// D1 = "00 00 00 00" + ENC UDK-A的最右边4个字节(DEK)
			Util.arrayCopyNonAtomic(paramBuf, PBOC_PARAM_OFF_DEK_KEY,
					sessionKey, (short) 0x00, (short) 0x08);
			Util.arrayFillNonAtomic(sessionKey, (short) 0x00, (short) 0x04,
					(byte) 0x00);

			// D3 XOR D1 = D2
			PBOCUtil.arrayXor(apduBuf, (short) (ISO7816.OFFSET_CDATA + 0x01),
					sessionKey, (short) 0x00, (short) 0x08);
			...
			Util.arrayFillNonAtomic(sessionKey, (short) 0x00, (short) 0x06,
					(byte) 0xFF);
			Util.arrayCopyNonAtomic(apduBuf,
					(short) (ISO7816.OFFSET_CDATA + 0x02), sessionKey,
					(short) 0x00, cntr);
			Util.arrayCopy(sessionKey, (short) 0x00, paramBuf,
					PBOC_PARAM_OFF_PIN_VALUE, (short) 0x06);
		}
	...
	private void onSelect(byte[] apduBuf) {
		...
		if ((apduBuf[ISO7816.OFFSET_P1] != 0x04) || (p2 < 0x00) || (p2 > 0x02)
				|| (p2 == 0x01)) {
			ISOException.throwIt(ISO7816.SW_INCORRECT_P1P2);
		}
	...
	private void onAppendRecord(APDU apdu) {
		...
		byte p2 = apduBuf[ISO7816.OFFSET_P2];
		byte sfi = (byte) ((byte) (apduBuf[ISO7816.OFFSET_P2] >> 0x03) & 0x1F);
		if (((byte) (p2 & 0x07) > 0x01) || (sfi == 0x00) || (sfi == 0x1F)) {
			ISOException.throwIt(ISO7816.SW_INCORRECT_P1P2);
		}
		...
		PBOCUtil.arrayXor(sessionKey, (short) 0x00, apduBuf, (short) 0x00,
				(short) 0x08);
		signMac.update(sessionKey, (short) 0x00, (short) 0x08);
		signMac.sign(apduBuf, (short) 0x08, (short) (p3 - 0x07), sessionKey,
				(short) 0x00);
		// mac verify failed
		if (Util.arrayCompare(apduBuf, (short) (p3 + 0x01), sessionKey,
				(short) 0x00, (short) 0x04) != 0x00) {
		...
		cipherECBDecrypt.doFinal(apduBuf, ISO7816.OFFSET_CDATA, (short) 0x10,
		...
		if (file[EXT_APP_FILE_OFF_TYPE] == EXT_APP_FILE_TYPE_LOG_FILE) {
			...
			short sRecNum = (short) (Util.getShort(file,
					EXT_APP_FILE_OFF_MAX_SIZE) / logFileRecLen);
			// record sequence number, 4 byte
			logFileRecLen = (short) (sRecLen + 0x04);
			short newFileSize = (short) (logFileRecLen * sRecNum);
			byte[] logFile = new byte[(short) (LOG_INFO_OFF_CONTENT
					+ newFileSize + 0x10)];
			...
			// 记录修改密钥
			Util.arrayCopyNonAtomic(apduBuf, ISO7816.OFFSET_CDATA, file,
					(short) (file.length - 0x10), (short) 0x10);

			file[(short) (LOG_INFO_OFF_CONTENT + 0x03)] = 0x01;
			Util.arrayCopyNonAtomic(apduBuf,
					(short) (ISO7816.OFFSET_CDATA + 0x10), file,
					(short) (LOG_INFO_OFF_CONTENT + 0x04), sRecLen);
		} else {
			...
			Util.arrayCopyNonAtomic(file, (short) 0x00, newFile, (short) 0x00,
					oldfileSize);
			...
			// write update key
			oldfileSize = Util.arrayCopyNonAtomic(apduBuf,
					ISO7816.OFFSET_CDATA, newFile, oldfileSize, (short) 0x10);
			// write record content
			Util.arrayCopyNonAtomic(apduBuf,
					(short) (ISO7816.OFFSET_CDATA + 0x10), newFile,
					oldfileSize, sRecLen);
		...
		if (extendFileCache == null) {
			if (RAM_CACHE) {
				if (FUNCTION_FOR_TIANYU) {
					extendFileCache = JCSystem
							.makeTransientByteArray(EXTEND_FILE_CACHE_BUF_SIZE,
									JCSystem.CLEAR_ON_RESET);
				} else {
					extendFileCache = JCSystem.makeTransientByteArray(
							EXTEND_FILE_CACHE_BUF_SIZE,
							JCSystem.CLEAR_ON_DESELECT);
				}
			} else {
			...
			if (FUNCTION_FOR_TIANYU) {
				extendFileCacheCurLen = JCSystem.makeTransientShortArray(
						(short) 0x01, JCSystem.CLEAR_ON_RESET);
			} else {
				extendFileCacheCurLen = JCSystem.makeTransientShortArray(
						(short) 0x01, JCSystem.CLEAR_ON_DESELECT);
			}
		}
	...
	private void onGetTransProve(APDU apdu) {
		...
		// 所需TC不可用
		if (Util.arrayCompare(abyCurTradeCardData,
				CARD_DATA_OFF_EXT_APP_LASTTRADE_INFO, apduBuf,
				ISO7816.OFFSET_CDATA, (short) 0x02) != 0x00) {
			ISOException.throwIt((short) 0x9406);
		}

		Util.arrayCopyNonAtomic(abyCurTradeCardData,
				(short) (CARD_DATA_OFF_EXT_APP_LASTTRADE_INFO + 0x02), apduBuf,
				(short) 0x00, (short) 0x08);
	...
	private void findExtAppFileNextRecord(byte type, byte sfi, short id) {
		...
		short sOffset = Util.getShort(abyPBOCTradeSession,
				TRADE_SESSION_DATA_OFF_EXT_APP_FILE_OFFSET);
		byte[] file = null;
		// 读取同一区号的下一条记录
		...
		while (sOffset < sFileLen) {
			...
			if (Util.getShort(file, (short) (sOffset + EXT_APP_RECORD_OFF_ID)) == id) {
				...
				Util.setShort(abyPBOCTradeSession,
						TRADE_SESSION_DATA_OFF_EXT_APP_FILE_OFFSET, sOffset);
				return;
			}
		...
		Util.setShort(abyPBOCTradeSession,
				TRADE_SESSION_DATA_OFF_EXT_APP_FILE_OFFSET, INVALID_VALUE);
	...
	private void onReadCAPPData(APDU apdu) {
		...
		if (abyPBOCTradeSession[TRADE_SESSION_DATA_OFF_SUPPORT_RMAC] == 0x01) {
			Util.arrayCopyNonAtomic(apduBuf, (short) 0x07, sessionKey,
					(short) 0x00, (short) 0x08);
		}
		...
		Util.arrayCopyNonAtomic(file,
				(short) (sOffset + EXT_APP_RECORD_OFF_ID), apduBuf,
				(short) 0x00, sLen);

		if (abyPBOCTradeSession[TRADE_SESSION_DATA_OFF_SUPPORT_RMAC] == 0x01) {
			tripleDesKey.setKey(file,
					(short) (sOffset + EXT_APP_RECORD_OFF_MNG_KEY));
			if (sLen > 0x08) {
				PBOCUtil.arrayXor(sessionKey, (short) 0x00, apduBuf,
						(short) 0x00, (short) 0x08);

				signMac.update(sessionKey, (short) 0x00, (short) 0x08);
				signMac.sign(apduBuf, (short) 0x08, (short) (sLen - 0x08),
						apduBuf, sLen);
			} else {
				PBOCUtil.arrayXor(sessionKey, (short) 0x00, apduBuf,
						(short) 0x00, sLen);
				...
				cipherECBEncrypt.doFinal(sessionKey, (short) 0x00,
						(short) 0x08, apduBuf, sLen);
			}
			sLen += 0x04;
		}
		...
		Util.setShort(abyPBOCTradeSession,
				TRADE_SESSION_DATA_OFF_EXT_APP_CUR_ID, id);
	...
	private void onUpdateCAPPDataCache(APDU apdu) {
		...
		if ((extendlogFile != null) && (extendlogFile[LOG_INFO_OFF_SFI] == sfi)) {
			...
			tripleDesKey.setKey(extendlogFile,
					(short) (extendlogFile.length - 0x10));
			...
			sOffset = Util.getShort(abyPBOCTradeSession,
					TRADE_SESSION_DATA_OFF_EXT_APP_FILE_OFFSET);
		...
		// backup CMAC
		Util.arrayCopyNonAtomic(apduBuf, (short) (p3 + 0x01), sessionKey,
				(short) 0x04, (short) 0x04);
		p3 -= 0x04;
		...
		if (bIsLogFile) {
			...
			cacheUpdateCAPPData((byte) 0xFF, INVALID_VALUE, apduBuf,
					(short) 0x01, (short) (p3 + 0x04));
		} else {
			cacheUpdateCAPPData(
					abyPBOCTradeSession[TRADE_SESSION_DATA_OFF_EXT_APP_FILE_INDEX],
					sOffset, apduBuf, ISO7816.OFFSET_CDATA, p3);
		}
		...
		if (abyPBOCTradeSession[TRADE_SESSION_DATA_OFF_SUPPORT_RMAC] == 0x01) {
			...
			cipherECBEncrypt.doFinal(sessionKey, (short) 0x00, (short) 0x08,
					apduBuf, (short) 0x00);
	...
	private void varInit() {
		if (extendFileCache != null) {
			Util.arrayFillNonAtomic(extendFileCache, (short) 0x00,
					EXTEND_FILE_CACHE_BUF_SIZE, (byte) 0x00);
			extendFileCacheCurLen[0x00] = 0x00;
		}
	...
	public void process(APDU apdu) throws ISOException {
		...
		if (selectingApplet()) {
			...
			Util.arrayCopyNonAtomic(abyFCI, (short) 0x00, apduBuf,
					(short) 0x00, sLen);

			// read card data
			Util.arrayCopyNonAtomic(cardDataBuf, (short) 0x00,
					abyCurTradeCardData, (short) 0x00,
					CURRENT_TRADE_CARD_DATA_BUF_SIZE);
		...
		if ((Util.getShort(backRecord, (short) 0x00) != 0x00)
				&& (ins != CMD_INS_READ_RECORD)
				&& (abyPBOCTradeSession[TRADE_SESSION_DATA_OFF_STATE] == TRADE_STATE_APP_SELECT)) {
		...
		case CMD_INS_STORE_DATA:
			...
			if (appState == APP_STATE_ISSUED) {
				...
				sc.unwrap(
						apduBuf,
						(short) 0x00,
						(short) (0x05 + (short) (apduBuf[ISO7816.OFFSET_LC] & 0x00FF)));
